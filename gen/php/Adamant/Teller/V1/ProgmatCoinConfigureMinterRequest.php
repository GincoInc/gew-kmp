...
/**
 * Generated from protobuf message <code>adamant.teller.v1.ProgmatCoinConfigureMinterRequest</code>
 */
class ProgmatCoinConfigureMinterRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $address = '';
    /**
     * Generated from protobuf field <code>string minter_allowed_amount = 5 [json_name = "minterAllowedAmount"];</code>
     */
    protected $minter_allowed_amount = '';
     ...
     *     @type string $address
     *     @type string $minter_allowed_amount
     * }
     */
     ...
     * @return string
     */
    public function getMinterAllowedAmount()
    {
        return $this->minter_allowed_amount;
    }
     ...
     * @return $this
     */
    public function setMinterAllowedAmount($var)
    {
        GPBUtil::checkString($var, True);
        $this->minter_allowed_amount = $var;
