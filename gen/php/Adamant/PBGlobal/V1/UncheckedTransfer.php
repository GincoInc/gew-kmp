 ...
 *
 * Generated from protobuf message <code>adamant.global.v1.UncheckedTransfer</code>
 */
class UncheckedTransfer extends \Google\Protobuf\Internal\Message
{
    /**
     * The id of wallet
     *
     ...
     * state
     *
     * Generated from protobuf field <code>.gincoinc.global.v1.TransactionState state = 6 [json_name = "state"];</code>
     */
    protected $state = 0;
    /**
     * result
     *
     * Generated from protobuf field <code>.gincoinc.global.v1.TransactionResult result = 7 [json_name = "result"];</code>
     */
    protected $result = 0;
    /**
     ...
     * The rate of fiat
     *
     * Generated from protobuf field <code>double jpy_rate = 10 [json_name = "jpyRate"];</code>
     */
    protected $jpy_rate = 0.0;
    /**
     * The wallet id to which the transfer send/receive
     *
     * Generated from protobuf field <code>string partner_wallet_id = 11 [json_name = "partnerWalletId"];</code>
     */
    protected $partner_wallet_id = '';
    /**
     * The address of wallet to which the transfer send/receive
     *
     * Generated from protobuf field <code>string partner_address = 12 [json_name = "partnerAddress"];</code>
     */
    protected $partner_address = '';
    /**
     * destination tag (only XRP)
     *
     * Generated from protobuf field <code>uint32 destination_tag = 13 [json_name = "destinationTag"];</code>
     */
    protected $destination_tag = 0;
    /**
     * memo id (only XLM)
     *
     * Generated from protobuf field <code>uint64 memo_id = 14 [json_name = "memoId", jstype = JS_STRING];</code>
     */
    protected $memo_id = 0;
    /**
     * message (only NEM)
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp create_time = 16 [json_name = "createTime"];</code>
     */
    protected $create_time = null;
    /**
     * the time at which the transfer was updated
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp update_time = 17 [json_name = "updateTime"];</code>
     */
