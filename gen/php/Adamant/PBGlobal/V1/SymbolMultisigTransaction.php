 ...
 *
 * Generated from protobuf message <code>adamant.global.v1.SymbolMultisigTransaction</code>
 */
class SymbolMultisigTransaction extends \Google\Protobuf\Internal\Message
{
    /**
     * The id of wallet
     *
    ...
    /**
     * Generated from protobuf field <code>string symbol_multisig_transaction_id = 3 [json_name = "symbolMultisigTransactionId"];</code>
     */
    protected $symbol_multisig_transaction_id = '';
    /**
     * Generated from protobuf field <code>.gincoinc.global.v1.SymbolTransactionType tx_type = 4 [json_name = "txType"];</code>
     */
    protected $tx_type = 0;
    /**
     ...
     *           id
     *     @type string $symbol_multisig_transaction_id
     *     @type int $tx_type
     *     @type string $data
     *           The string-typed amount of transaction fee
     ...
     * @return string
     */
    public function getSymbolMultisigTransactionId()
    {
        return $this->symbol_multisig_transaction_id;
    }
     ...
     * @return $this
     */
    public function setSymbolMultisigTransactionId($var)
    {
        GPBUtil::checkString($var, True);
        $this->symbol_multisig_transaction_id = $var;
