...
type Wallet struct {
	...
	RequiredApprovalCount uint32                       `protobuf:"varint,20,opt,name=required_approval_count,json=requiredApprovalCount,proto3" json:"required_approval_count,omitempty"`    // The number of approvals by validator which is required to transfer asset, update wallet info etc.
	...
	DestinationWalletId   string                       `protobuf:"bytes,19,opt,name=destination_wallet_id,json=destinationWalletId,proto3" json:"destination_wallet_id,omitempty"`           // The id of wallet to which the tx is send (only wallet type is WALLET_TYPE_SELF_CUSTODY_HOT_ETHEREUM_EOA_RECEIVE_ONLY)
	...
	CreateTime            *timestamp.Timestamp         `protobuf:"bytes,15,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                        // the time at which the wallet was created
	UpdateTime            *timestamp.Timestamp         `protobuf:"bytes,16,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                        // the time at which the wallet was updated
}
...
func (x *Wallet) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Wallet) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *WalletWithoutBalance) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *WalletWithoutBalance) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type WalletProposal struct {
	...
	ProposedPolicy                string             `protobuf:"bytes,5,opt,name=proposed_policy,json=proposedPolicy,proto3" json:"proposed_policy,omitempty"`                                                   // The proposed id of the policy which is trying to be applied in the proposal
...
type WalletMember struct {
	...
	IsMaster                  bool        `protobuf:"varint,7,opt,name=is_master,json=isMaster,proto3" json:"is_master,omitempty"`                                                          // The flag which indicates the member is master user (only XRP wallet)
...
type Address struct {
	...
	CreateTime    *timestamp.Timestamp         `protobuf:"bytes,11,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                        // the time at which the address was created
	UpdateTime    *timestamp.Timestamp         `protobuf:"bytes,12,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                        // the time at which the address was updated
}
...
func (x *Address) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Address) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type AddressWithoutBalance struct {
	...
	CreateTime  *timestamp.Timestamp         `protobuf:"bytes,8,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                         // the time at which the address was created
	UpdateTime  *timestamp.Timestamp         `protobuf:"bytes,9,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                         // the time at which the address was updated
}
...
func (x *AddressWithoutBalance) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *AddressWithoutBalance) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type Transaction struct {
	...
	FeeRate             uint64                `protobuf:"varint,12,opt,name=fee_rate,json=feeRate,proto3" json:"fee_rate,omitempty"`                                    // The fee rate of transaction (only BTC and its forks. unit: sat/Byte)
...
func (x *Transaction) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Transaction) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type SubstrateMultisigTransaction struct {
	...
	CreateTime                     *timestamp.Timestamp `protobuf:"bytes,13,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`              // the time at which the transaction was created
	UpdateTime                     *timestamp.Timestamp `protobuf:"bytes,14,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`              // the time at which the transaction was updated
}
...
func (x *SubstrateMultisigTransaction) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *SubstrateMultisigTransaction) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type Transfer struct {
	...
	CreateTime      *timestamp.Timestamp               `protobuf:"bytes,13,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                            // the time at which the transfer was created
	UpdateTime      *timestamp.Timestamp               `protobuf:"bytes,14,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                            // the time at which the transfer was updated
}
...
func (x *Transfer) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Transfer) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type UncheckedTransfer struct {
	...
	CreateTime      *timestamp.Timestamp               `protobuf:"bytes,16,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                            // the time at which the transfer was created
	UpdateTime      *timestamp.Timestamp               `protobuf:"bytes,17,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                            // the time at which the transfer was updated
}
...
func (x *UncheckedTransfer) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *UncheckedTransfer) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *EventTriggeredMessage) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *EventTriggeredMessage) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type LabeledAddress struct {
	...
	CreateTime       *timestamp.Timestamp    `protobuf:"bytes,7,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                     // the time at which the labeled address was created
	UpdateTime       *timestamp.Timestamp    `protobuf:"bytes,8,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                     // the time at which the labeled address was updated
}
...
func (x *LabeledAddress) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *LabeledAddress) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type Whitelist struct {
	...
	CreateTime  *timestamp.Timestamp  `protobuf:"bytes,6,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`    // the time at which the whitelist was created
	UpdateTime  *timestamp.Timestamp  `protobuf:"bytes,7,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`    // the time at which the whitelist was updated
}
...
func (x *Whitelist) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Whitelist) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type TransferLimit struct {
	...
	CreateTime      *timestamp.Timestamp   `protobuf:"bytes,10,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                 // the time at which the whitelist was created
	UpdateTime      *timestamp.Timestamp   `protobuf:"bytes,11,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                 // the time at which the whitelist was updated
}
...
func (x *TransferLimit) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *TransferLimit) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type Policy struct {
	...
	CreateTime    *timestamp.Timestamp  `protobuf:"bytes,9,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`                                    // the time at which the policy was created
	UpdateTime    *timestamp.Timestamp  `protobuf:"bytes,10,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`                                   // the time at which the policy was updated
}
...
func (x *WalletFlushSetting) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *WalletFlushSetting) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *CompensationFee) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *WalletGroup) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *WalletGroup) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
var file_gincoinc_adamant_global_v1_adamantglobalv1_model_proto_rawDesc = []byte{
	...
	,
	...
	0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa5, 0x08, 0x0a,
	...
	0x65, 0x65, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x8f, 0x0b, 0x0a, 0x0b, 0x54, 0x72,
	...
	0x61, 0x6e, 0x67, 0x65, 0x22, 0xfa, 0x01, 0x0a, 0x04, 0x55, 0x54, 0x58, 0x4f, 0x12, 0x13, 0x0a,
	...
	0x64, 0x22, 0x86, 0x01, 0x0a, 0x0f, 0x42, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e, 0x53, 0x70, 0x65,
	...
	0x70, 0x75, 0x74, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x13, 0x42, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e,
	0x63, 0x61, 0x73, 0x68, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63, 0x12, 0x37, 0x0a, 0x09,
	...
	0x73, 0x22, 0xe0, 0x01, 0x0a, 0x10, 0x45, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x53, 0x70,
	...
	,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xe2, 0x01, 0x0a, 0x22, 0x43, 0x72, 0x65,
	...
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0xef, 0x04, 0x0a, 0x1c, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72,
	...
	0x65, 0x78, 0x22, 0xb6, 0x05, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12,
	...
	0x6d, 0x65, 0x6d, 0x6f, 0x49, 0x64, 0x12, 0x3a, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52,
	0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xe0, 0x05, 0x0a, 0x11,
	...
	0x6f, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x68, 0x61, 0x73, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b,
	...
	0x65, 0x42, 0x11, 0x5a, 0x0f, 0x61, 0x64, 0x61, 0x6d, 0x61, 0x6e, 0x74, 0x67, 0x6c, 0x6f, 0x62,
...
var file_gincoinc_adamant_global_v1_adamantglobalv1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 76)
var file_gincoinc_adamant_global_v1_adamantglobalv1_model_proto_goTypes = []interface{}{
	...
	(*CreateTransactionSubstrateSpecific)(nil),     // 25: adamant.global.v1.CreateTransactionSubstrateSpecific
	(*CreateTransactionWalletConnectSpecific)(nil), // 26: adamant.global.v1.CreateTransactionWalletConnectSpecific
	(*SubstrateMultisigTransaction)(nil),           // 27: adamant.global.v1.SubstrateMultisigTransaction
	(*SignInfo)(nil),                               // 28: adamant.global.v1.SignInfo
	(*SignTxInput)(nil),                            // 29: adamant.global.v1.SignTxInput
	(*Transfer)(nil),                               // 30: adamant.global.v1.Transfer
	(*UncheckedTransfer)(nil),                      // 31: adamant.global.v1.UncheckedTransfer
	(*EventTriggeredMessage)(nil),                  // 32: adamant.global.v1.EventTriggeredMessage
	(*Rate)(nil),                                   // 33: adamant.global.v1.Rate
	(*RateSnapshot)(nil),                           // 34: adamant.global.v1.RateSnapshot
	(*Deactivatability)(nil),                       // 35: adamant.global.v1.Deactivatability
	(*LabeledAddress)(nil),                         // 36: adamant.global.v1.LabeledAddress
	(*LabeledAddressProposal)(nil),                 // 37: adamant.global.v1.LabeledAddressProposal
	(*Whitelist)(nil),                              // 38: adamant.global.v1.Whitelist
	(*TransferLimit)(nil),                          // 39: adamant.global.v1.TransferLimit
	(*TransferLimitProposal)(nil),                  // 40: adamant.global.v1.TransferLimitProposal
	(*Policy)(nil),                                 // 41: adamant.global.v1.Policy
	(*PolicyProposal)(nil),                         // 42: adamant.global.v1.PolicyProposal
	(*TotalBalanceByCoin)(nil),                     // 43: adamant.global.v1.TotalBalanceByCoin
	(*TotalBalance)(nil),                           // 44: adamant.global.v1.TotalBalance
	(*BalanceSnapshot)(nil),                        // 45: adamant.global.v1.BalanceSnapshot
	(*WalletBalanceSnapshotMap)(nil),               // 46: adamant.global.v1.WalletBalanceSnapshotMap
	(*ListWalletBalanceSnapshots)(nil),             // 47: adamant.global.v1.ListWalletBalanceSnapshots
	(*WalletBalanceSnapshot)(nil),                  // 48: adamant.global.v1.WalletBalanceSnapshot
	(*TransferVolumeSnapshots)(nil),                // 49: adamant.global.v1.TransferVolumeSnapshots
	(*ListTransferVolumeSnapshots)(nil),            // 50: adamant.global.v1.ListTransferVolumeSnapshots
	(*TransferVolumeSnapshot)(nil),                 // 51: adamant.global.v1.TransferVolumeSnapshot
	(*TransferVolume)(nil),                         // 52: adamant.global.v1.TransferVolume
	(*WalletTransferVolumeSnapshots)(nil),          // 53: adamant.global.v1.WalletTransferVolumeSnapshots
	(*ListWalletTransferVolumeSnapshots)(nil),      // 54: adamant.global.v1.ListWalletTransferVolumeSnapshots
	(*WalletTransferVolumeSnapshot)(nil),           // 55: adamant.global.v1.WalletTransferVolumeSnapshot
	(*WalletTransferVolume)(nil),                   // 56: adamant.global.v1.WalletTransferVolume
	(*Confirmation)(nil),                           // 57: adamant.global.v1.Confirmation
	(*WalletFlushSetting)(nil),                     // 58: adamant.global.v1.WalletFlushSetting
	(*CompensationFee)(nil),                        // 59: adamant.global.v1.CompensationFee
	(*WalletGroup)(nil),                            // 60: adamant.global.v1.WalletGroup
	(*RequestTxOutput)(nil),                        // 61: adamant.global.v1.RequestTxOutput
	(*RequestSignedInfo)(nil),                      // 62: adamant.global.v1.RequestSignedInfo
	(*RequestSignature)(nil),                       // 63: adamant.global.v1.RequestSignature
	(*RequestTransferLimitEntry)(nil),              // 64: adamant.global.v1.RequestTransferLimitEntry
	(*RequestRate)(nil),                            // 65: adamant.global.v1.RequestRate
	(*SubstrateChildAddress)(nil),                  // 66: adamant.global.v1.SubstrateChildAddress
	nil,                                            // 67: adamant.global.v1.RateSnapshot.RatesEntry
	nil,                                            // 68: adamant.global.v1.TotalBalance.TotalBalancesEntry
	nil,                                            // 69: adamant.global.v1.BalanceSnapshot.TotalBalancesEntry
	nil,                                            // 70: adamant.global.v1.BalanceSnapshot.RatesEntry
	nil,                                            // 71: adamant.global.v1.WalletBalanceSnapshotMap.WalletBalanceSnapshotMapEntry
	nil,                                            // 72: adamant.global.v1.TransferVolumeSnapshots.TransferVolumeSnapshotByTransferTypeEntry
	nil,                                            // 73: adamant.global.v1.TransferVolumeSnapshot.TransferVolumeByCoinEntry
	nil,                                            // 74: adamant.global.v1.WalletTransferVolumeSnapshots.WalletTransferVolumeSnapshotByWalletIdEntry
	nil,                                            // 75: adamant.global.v1.WalletTransferVolumeSnapshot.WalletTransferVolumeByTransferTypeEntry
	(gincoincglobalv1.Coin)(0),                     // 76: gincoinc.global.v1.Coin
	(WalletType)(0),                                // 77: adamant.global.v1.WalletType
	(gincoincglobalv1.AddressType)(0),              // 78: gincoinc.global.v1.AddressType
	(WalletState)(0),                               // 79: adamant.global.v1.WalletState
	(*timestamp.Timestamp)(nil),                    // 80: google.protobuf.Timestamp
	(WalletProposalType)(0),                        // 81: adamant.global.v1.WalletProposalType
	(AccountType)(0),                               // 82: adamant.global.v1.AccountType
	(RoleType)(0),                                  // 83: adamant.global.v1.RoleType
	(AddressState)(0),                              // 84: adamant.global.v1.AddressState
	(TransactionState)(0),                          // 85: adamant.global.v1.TransactionState
	(EthereumContractMethodIDType)(0),              // 86: adamant.global.v1.EthereumContractMethodIDType
	(gincoincglobalv1.XRPTransactionType)(0),       // 87: gincoinc.global.v1.XRPTransactionType
	(SubstrateCallType)(0),                         // 88: adamant.global.v1.SubstrateCallType
	(WalletConnectCallRequestType)(0),              // 89: adamant.global.v1.WalletConnectCallRequestType
	(gincoincglobalv1.TransferType)(0),             // 90: gincoinc.global.v1.TransferType
	(gincoincglobalv1.TransactionState)(0),         // 91: gincoinc.global.v1.TransactionState
	(gincoincglobalv1.TransactionResult)(0),        // 92: gincoinc.global.v1.TransactionResult
	(EventTriggeredMessageType)(0),                 // 93: adamant.global.v1.EventTriggeredMessageType
	(PolicyType)(0),                                // 94: adamant.global.v1.PolicyType
	(TransferLimitType)(0),                         // 95: adamant.global.v1.TransferLimitType
}
var file_gincoinc_adamant_global_v1_adamantglobalv1_model_proto_depIdxs = []int32{
	76,  // 0: adamant.global.v1.Wallet.coin:type_name -> gincoinc.global.v1.Coin
	77,  // 1: adamant.global.v1.Wallet.wallet_type:type_name -> adamant.global.v1.WalletType
	78,  // 2: adamant.global.v1.Wallet.address_type:type_name -> gincoinc.global.v1.AddressType
	79,  // 3: adamant.global.v1.Wallet.state:type_name -> adamant.global.v1.WalletState
	...
	80,  // 7: adamant.global.v1.Wallet.create_time:type_name -> google.protobuf.Timestamp
	80,  // 8: adamant.global.v1.Wallet.update_time:type_name -> google.protobuf.Timestamp
	76,  // 9: adamant.global.v1.WalletWithoutBalance.coin:type_name -> gincoinc.global.v1.Coin
	77,  // 10: adamant.global.v1.WalletWithoutBalance.wallet_type:type_name -> adamant.global.v1.WalletType
	78,  // 11: adamant.global.v1.WalletWithoutBalance.address_type:type_name -> gincoinc.global.v1.AddressType
	79,  // 12: adamant.global.v1.WalletWithoutBalance.state:type_name -> adamant.global.v1.WalletState
	...
	80,  // 16: adamant.global.v1.WalletWithoutBalance.create_time:type_name -> google.protobuf.Timestamp
	80,  // 17: adamant.global.v1.WalletWithoutBalance.update_time:type_name -> google.protobuf.Timestamp
	81,  // 18: adamant.global.v1.WalletProposal.proposal_type:type_name -> adamant.global.v1.WalletProposalType
	82,  // 19: adamant.global.v1.WalletMember.account_type:type_name -> adamant.global.v1.AccountType
	83,  // 20: adamant.global.v1.WalletMember.role:type_name -> adamant.global.v1.RoleType
	82,  // 21: adamant.global.v1.Key.account_type:type_name -> adamant.global.v1.AccountType
	76,  // 22: adamant.global.v1.Address.coin:type_name -> gincoinc.global.v1.Coin
	84,  // 23: adamant.global.v1.Address.state:type_name -> adamant.global.v1.AddressState
	78,  // 24: adamant.global.v1.Address.address_type:type_name -> gincoinc.global.v1.AddressType
	80,  // 25: adamant.global.v1.Address.create_time:type_name -> google.protobuf.Timestamp
	80,  // 26: adamant.global.v1.Address.update_time:type_name -> google.protobuf.Timestamp
	76,  // 27: adamant.global.v1.AddressWithoutBalance.coin:type_name -> gincoinc.global.v1.Coin
	84,  // 28: adamant.global.v1.AddressWithoutBalance.state:type_name -> adamant.global.v1.AddressState
	78,  // 29: adamant.global.v1.AddressWithoutBalance.address_type:type_name -> gincoinc.global.v1.AddressType
	80,  // 30: adamant.global.v1.AddressWithoutBalance.create_time:type_name -> google.protobuf.Timestamp
	80,  // 31: adamant.global.v1.AddressWithoutBalance.update_time:type_name -> google.protobuf.Timestamp
	76,  // 32: adamant.global.v1.FlushedAddress.coin:type_name -> gincoinc.global.v1.Coin
	84,  // 33: adamant.global.v1.FlushedAddress.state:type_name -> adamant.global.v1.AddressState
	78,  // 34: adamant.global.v1.FlushedAddress.address_type:type_name -> gincoinc.global.v1.AddressType
	76,  // 35: adamant.global.v1.Transaction.coin:type_name -> gincoinc.global.v1.Coin
	85,  // 36: adamant.global.v1.Transaction.state:type_name -> adamant.global.v1.TransactionState
	...
	80,  // 49: adamant.global.v1.Transaction.create_time:type_name -> google.protobuf.Timestamp
	80,  // 50: adamant.global.v1.Transaction.update_time:type_name -> google.protobuf.Timestamp
	82,  // 51: adamant.global.v1.TransactionMember.account_type:type_name -> adamant.global.v1.AccountType
	83,  // 52: adamant.global.v1.TransactionMember.role:type_name -> adamant.global.v1.RoleType
	12,  // 53: adamant.global.v1.BitcoinSpecific.tx_inputs:type_name -> adamant.global.v1.TxInput
	13,  // 54: adamant.global.v1.BitcoinSpecific.tx_outputs:type_name -> adamant.global.v1.TxOutput
	12,  // 55: adamant.global.v1.LitecoinSpecific.tx_inputs:type_name -> adamant.global.v1.TxInput
	13,  // 56: adamant.global.v1.LitecoinSpecific.tx_outputs:type_name -> adamant.global.v1.TxOutput
	12,  // 57: adamant.global.v1.BitcoincashSpecific.tx_inputs:type_name -> adamant.global.v1.TxInput
	13,  // 58: adamant.global.v1.BitcoincashSpecific.tx_outputs:type_name -> adamant.global.v1.TxOutput
	86,  // 59: adamant.global.v1.EthereumSpecific.method_id_type:type_name -> adamant.global.v1.EthereumContractMethodIDType
	87,  // 60: adamant.global.v1.XrpSpecific.tx_type:type_name -> gincoinc.global.v1.XRPTransactionType
	12,  // 61: adamant.global.v1.C0banSpecific.tx_inputs:type_name -> adamant.global.v1.TxInput
	13,  // 62: adamant.global.v1.C0banSpecific.tx_outputs:type_name -> adamant.global.v1.TxOutput
	12,  // 63: adamant.global.v1.CardanoSpecific.tx_inputs:type_name -> adamant.global.v1.TxInput
	13,  // 64: adamant.global.v1.CardanoSpecific.tx_outputs:type_name -> adamant.global.v1.TxOutput
	27,  // 65: adamant.global.v1.SubstrateSpecific.substrate_multisig_transactions:type_name -> adamant.global.v1.SubstrateMultisigTransaction
	88,  // 66: adamant.global.v1.CreateTransactionSubstrateSpecific.call_type:type_name -> adamant.global.v1.SubstrateCallType
	88,  // 67: adamant.global.v1.CreateTransactionSubstrateSpecific.multisig_call_type:type_name -> adamant.global.v1.SubstrateCallType
	89,  // 68: adamant.global.v1.CreateTransactionWalletConnectSpecific.call_request_type:type_name -> adamant.global.v1.WalletConnectCallRequestType
	88,  // 69: adamant.global.v1.SubstrateMultisigTransaction.multisig_call_type:type_name -> adamant.global.v1.SubstrateCallType
	85,  // 70: adamant.global.v1.SubstrateMultisigTransaction.state:type_name -> adamant.global.v1.TransactionState
	80,  // 71: adamant.global.v1.SubstrateMultisigTransaction.create_time:type_name -> google.protobuf.Timestamp
	80,  // 72: adamant.global.v1.SubstrateMultisigTransaction.update_time:type_name -> google.protobuf.Timestamp
	76,  // 73: adamant.global.v1.SignInfo.coin:type_name -> gincoinc.global.v1.Coin
	29,  // 74: adamant.global.v1.SignInfo.sign_tx_inputs:type_name -> adamant.global.v1.SignTxInput
	76,  // 75: adamant.global.v1.Transfer.coin:type_name -> gincoinc.global.v1.Coin
	90,  // 76: adamant.global.v1.Transfer.transfer_type:type_name -> gincoinc.global.v1.TransferType
	91,  // 77: adamant.global.v1.Transfer.state:type_name -> gincoinc.global.v1.TransactionState
	92,  // 78: adamant.global.v1.Transfer.result:type_name -> gincoinc.global.v1.TransactionResult
	80,  // 79: adamant.global.v1.Transfer.create_time:type_name -> google.protobuf.Timestamp
	80,  // 80: adamant.global.v1.Transfer.update_time:type_name -> google.protobuf.Timestamp
	76,  // 81: adamant.global.v1.UncheckedTransfer.coin:type_name -> gincoinc.global.v1.Coin
	90,  // 82: adamant.global.v1.UncheckedTransfer.transfer_type:type_name -> gincoinc.global.v1.TransferType
	91,  // 83: adamant.global.v1.UncheckedTransfer.state:type_name -> gincoinc.global.v1.TransactionState
	92,  // 84: adamant.global.v1.UncheckedTransfer.result:type_name -> gincoinc.global.v1.TransactionResult
	80,  // 85: adamant.global.v1.UncheckedTransfer.create_time:type_name -> google.protobuf.Timestamp
	80,  // 86: adamant.global.v1.UncheckedTransfer.update_time:type_name -> google.protobuf.Timestamp
	93,  // 87: adamant.global.v1.EventTriggeredMessage.event_triggered_message_type:type_name -> adamant.global.v1.EventTriggeredMessageType
	80,  // 88: adamant.global.v1.EventTriggeredMessage.create_time:type_name -> google.protobuf.Timestamp
	80,  // 89: adamant.global.v1.EventTriggeredMessage.update_time:type_name -> google.protobuf.Timestamp
	76,  // 90: adamant.global.v1.Rate.coin:type_name -> gincoinc.global.v1.Coin
	67,  // 91: adamant.global.v1.RateSnapshot.rates:type_name -> adamant.global.v1.RateSnapshot.RatesEntry
	76,  // 92: adamant.global.v1.LabeledAddress.coin:type_name -> gincoinc.global.v1.Coin
	37,  // 93: adamant.global.v1.LabeledAddress.proposal:type_name -> adamant.global.v1.LabeledAddressProposal
	80,  // 94: adamant.global.v1.LabeledAddress.create_time:type_name -> google.protobuf.Timestamp
	80,  // 95: adamant.global.v1.LabeledAddress.update_time:type_name -> google.protobuf.Timestamp
	76,  // 96: adamant.global.v1.Whitelist.coin:type_name -> gincoinc.global.v1.Coin
	36,  // 97: adamant.global.v1.Whitelist.addresses:type_name -> adamant.global.v1.LabeledAddress
	80,  // 98: adamant.global.v1.Whitelist.create_time:type_name -> google.protobuf.Timestamp
	80,  // 99: adamant.global.v1.Whitelist.update_time:type_name -> google.protobuf.Timestamp
	76,  // 100: adamant.global.v1.TransferLimit.coin:type_name -> gincoinc.global.v1.Coin
	40,  // 101: adamant.global.v1.TransferLimit.proposal:type_name -> adamant.global.v1.TransferLimitProposal
	80,  // 102: adamant.global.v1.TransferLimit.create_time:type_name -> google.protobuf.Timestamp
	80,  // 103: adamant.global.v1.TransferLimit.update_time:type_name -> google.protobuf.Timestamp
	94,  // 104: adamant.global.v1.Policy.policy_type:type_name -> adamant.global.v1.PolicyType
	76,  // 105: adamant.global.v1.Policy.coin:type_name -> gincoinc.global.v1.Coin
	38,  // 106: adamant.global.v1.Policy.whitelist:type_name -> adamant.global.v1.Whitelist
	39,  // 107: adamant.global.v1.Policy.transfer_limit:type_name -> adamant.global.v1.TransferLimit
	42,  // 108: adamant.global.v1.Policy.proposal:type_name -> adamant.global.v1.PolicyProposal
	80,  // 109: adamant.global.v1.Policy.create_time:type_name -> google.protobuf.Timestamp
	80,  // 110: adamant.global.v1.Policy.update_time:type_name -> google.protobuf.Timestamp
	38,  // 111: adamant.global.v1.PolicyProposal.proposed_whitelist:type_name -> adamant.global.v1.Whitelist
	76,  // 112: adamant.global.v1.TotalBalanceByCoin.coin:type_name -> gincoinc.global.v1.Coin
	68,  // 113: adamant.global.v1.TotalBalance.total_balances:type_name -> adamant.global.v1.TotalBalance.TotalBalancesEntry
	80,  // 114: adamant.global.v1.BalanceSnapshot.create_time:type_name -> google.protobuf.Timestamp
	69,  // 115: adamant.global.v1.BalanceSnapshot.total_balances:type_name -> adamant.global.v1.BalanceSnapshot.TotalBalancesEntry
	70,  // 116: adamant.global.v1.BalanceSnapshot.rates:type_name -> adamant.global.v1.BalanceSnapshot.RatesEntry
	71,  // 117: adamant.global.v1.WalletBalanceSnapshotMap.wallet_balance_snapshot_map:type_name -> adamant.global.v1.WalletBalanceSnapshotMap.WalletBalanceSnapshotMapEntry
	48,  // 118: adamant.global.v1.ListWalletBalanceSnapshots.wallet_balance_snapshots:type_name -> adamant.global.v1.WalletBalanceSnapshot
	80,  // 119: adamant.global.v1.WalletBalanceSnapshot.create_time:type_name -> google.protobuf.Timestamp
	72,  // 120: adamant.global.v1.TransferVolumeSnapshots.transfer_volume_snapshot_by_transfer_type:type_name -> adamant.global.v1.TransferVolumeSnapshots.TransferVolumeSnapshotByTransferTypeEntry
	51,  // 121: adamant.global.v1.ListTransferVolumeSnapshots.transfer_volume_snapshots:type_name -> adamant.global.v1.TransferVolumeSnapshot
	80,  // 122: adamant.global.v1.TransferVolumeSnapshot.target_time:type_name -> google.protobuf.Timestamp
	73,  // 123: adamant.global.v1.TransferVolumeSnapshot.transfer_volume_by_coin:type_name -> adamant.global.v1.TransferVolumeSnapshot.TransferVolumeByCoinEntry
	76,  // 124: adamant.global.v1.TransferVolume.coin:type_name -> gincoinc.global.v1.Coin
	90,  // 125: adamant.global.v1.TransferVolume.transfer_type:type_name -> gincoinc.global.v1.TransferType
	74,  // 126: adamant.global.v1.WalletTransferVolumeSnapshots.wallet_transfer_volume_snapshot_by_wallet_id:type_name -> adamant.global.v1.WalletTransferVolumeSnapshots.WalletTransferVolumeSnapshotByWalletIdEntry
	55,  // 127: adamant.global.v1.ListWalletTransferVolumeSnapshots.wallet_transfer_volume_snapshots:type_name -> adamant.global.v1.WalletTransferVolumeSnapshot
	80,  // 128: adamant.global.v1.WalletTransferVolumeSnapshot.target_time:type_name -> google.protobuf.Timestamp
	75,  // 129: adamant.global.v1.WalletTransferVolumeSnapshot.wallet_transfer_volume_by_transfer_type:type_name -> adamant.global.v1.WalletTransferVolumeSnapshot.WalletTransferVolumeByTransferTypeEntry
	90,  // 130: adamant.global.v1.WalletTransferVolume.transfer_type:type_name -> gincoinc.global.v1.TransferType
	76,  // 131: adamant.global.v1.Confirmation.coin:type_name -> gincoinc.global.v1.Coin
	76,  // 132: adamant.global.v1.WalletFlushSetting.coin:type_name -> gincoinc.global.v1.Coin
	80,  // 133: adamant.global.v1.WalletFlushSetting.create_time:type_name -> google.protobuf.Timestamp
	80,  // 134: adamant.global.v1.WalletFlushSetting.update_time:type_name -> google.protobuf.Timestamp
	80,  // 135: adamant.global.v1.CompensationFee.create_time:type_name -> google.protobuf.Timestamp
	76,  // 136: adamant.global.v1.WalletGroup.coin:type_name -> gincoinc.global.v1.Coin
	0,   // 137: adamant.global.v1.WalletGroup.wallets:type_name -> adamant.global.v1.Wallet
	80,  // 138: adamant.global.v1.WalletGroup.create_time:type_name -> google.protobuf.Timestamp
	80,  // 139: adamant.global.v1.WalletGroup.update_time:type_name -> google.protobuf.Timestamp
	63,  // 140: adamant.global.v1.RequestSignedInfo.signatures:type_name -> adamant.global.v1.RequestSignature
	95,  // 141: adamant.global.v1.RequestTransferLimitEntry.transfer_limit_type:type_name -> adamant.global.v1.TransferLimitType
	76,  // 142: adamant.global.v1.RequestRate.coin:type_name -> gincoinc.global.v1.Coin
	33,  // 143: adamant.global.v1.RateSnapshot.RatesEntry.value:type_name -> adamant.global.v1.Rate
	43,  // 144: adamant.global.v1.TotalBalance.TotalBalancesEntry.value:type_name -> adamant.global.v1.TotalBalanceByCoin
	43,  // 145: adamant.global.v1.BalanceSnapshot.TotalBalancesEntry.value:type_name -> adamant.global.v1.TotalBalanceByCoin
	33,  // 146: adamant.global.v1.BalanceSnapshot.RatesEntry.value:type_name -> adamant.global.v1.Rate
	47,  // 147: adamant.global.v1.WalletBalanceSnapshotMap.WalletBalanceSnapshotMapEntry.value:type_name -> adamant.global.v1.ListWalletBalanceSnapshots
	50,  // 148: adamant.global.v1.TransferVolumeSnapshots.TransferVolumeSnapshotByTransferTypeEntry.value:type_name -> adamant.global.v1.ListTransferVolumeSnapshots
	52,  // 149: adamant.global.v1.TransferVolumeSnapshot.TransferVolumeByCoinEntry.value:type_name -> adamant.global.v1.TransferVolume
	54,  // 150: adamant.global.v1.WalletTransferVolumeSnapshots.WalletTransferVolumeSnapshotByWalletIdEntry.value:type_name -> adamant.global.v1.ListWalletTransferVolumeSnapshots
	56,  // 151: adamant.global.v1.WalletTransferVolumeSnapshot.WalletTransferVolumeByTransferTypeEntry.value:type_name -> adamant.global.v1.WalletTransferVolume
