...
type GlobalAPIClient interface {
	...
	ListBaseWalletsForEVMAddressSharing(ctx context.Context, in *ListBaseWalletsForEVMAddressSharingRequest, opts ...grpc.CallOption) (*ListBaseWalletsResponse, error)
...
func (c *globalAPIClient) ListBaseWalletsForEVMAddressSharing(ctx context.Context, in *ListBaseWalletsForEVMAddressSharingRequest, opts ...grpc.CallOption) (*ListBaseWalletsResponse, error) {
	out := new(ListBaseWalletsResponse)
	err := c.cc.Invoke(ctx, "/adamant.global.v1.GlobalAPI/ListBaseWalletsForEVMAddressSharing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GlobalAPIServer interface {
	...
	ListBaseWalletsForEVMAddressSharing(context.Context, *ListBaseWalletsForEVMAddressSharingRequest) (*ListBaseWalletsResponse, error)
...
func (UnimplementedGlobalAPIServer) ListBaseWalletsForEVMAddressSharing(context.Context, *ListBaseWalletsForEVMAddressSharingRequest) (*ListBaseWalletsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListBaseWalletsForEVMAddressSharing not implemented")
}
...
func _GlobalAPI_ListBaseWalletsForEVMAddressSharing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListBaseWalletsForEVMAddressSharingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GlobalAPIServer).ListBaseWalletsForEVMAddressSharing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/adamant.global.v1.GlobalAPI/ListBaseWalletsForEVMAddressSharing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GlobalAPIServer).ListBaseWalletsForEVMAddressSharing(ctx, req.(*ListBaseWalletsForEVMAddressSharingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GlobalAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListBaseWalletsForEVMAddressSharing",
			Handler:    _GlobalAPI_ListBaseWalletsForEVMAddressSharing_Handler,
		},
		{
