...
func (m *TxInput) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TxInputValidationError{
					field:  "CantonSpecific",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// Validate checks the field values on CantonTxInputSpecific with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CantonTxInputSpecific) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CantonTxInputSpecific with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CantonTxInputSpecificMultiError, or nil if none found.
func (m *CantonTxInputSpecific) ValidateAll() error {
	return m.validate(true)
}

func (m *CantonTxInputSpecific) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CantonTxInputSpecificMultiError(errors)
	}

	return nil
}

// CantonTxInputSpecificMultiError is an error wrapping multiple validation
// errors returned by CantonTxInputSpecific.ValidateAll() if the designated
// constraints aren't met.
type CantonTxInputSpecificMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CantonTxInputSpecificMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CantonTxInputSpecificMultiError) AllErrors() []error { return m }

// CantonTxInputSpecificValidationError is the validation error returned by
// CantonTxInputSpecific.Validate if the designated constraints aren't met.
type CantonTxInputSpecificValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CantonTxInputSpecificValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CantonTxInputSpecificValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CantonTxInputSpecificValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CantonTxInputSpecificValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CantonTxInputSpecificValidationError) ErrorName() string {
	return "CantonTxInputSpecificValidationError"
}

// Error satisfies the builtin error interface
func (e CantonTxInputSpecificValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCantonTxInputSpecific.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CantonTxInputSpecificValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CantonTxInputSpecificValidationError{}
...
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SlashingTxSignInfo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SlashingTxSignInfo with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SlashingTxSignInfoMultiError, or nil if none found.
func (m *SlashingTxSignInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *SlashingTxSignInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		switch v := interface{}(m.GetSignTxInput()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SlashingTxSignInfoValidationError{
					field:  "SignTxInput",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetSignTxInput()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return SlashingTxSignInfoValidationError{
				field:  "SignTxInput",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if all {
		switch v := interface{}(m.GetInputUtxo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SlashingTxSignInfoValidationError{
					field:  "InputUtxo",
	...
	} else if v, ok := interface{}(m.GetInputUtxo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return SlashingTxSignInfoValidationError{
				field:  "InputUtxo",
				reason: "embedded message failed validation",
	...
	for idx, item := range m.GetOutputUtxos() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SlashingTxSignInfoValidationError{
						field:  fmt.Sprintf("OutputUtxos[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
	...
	if len(errors) > 0 {
		return SlashingTxSignInfoMultiError(errors)
	}

	return nil
}

// SlashingTxSignInfoMultiError is an error wrapping multiple validation errors
// returned by SlashingTxSignInfo.ValidateAll() if the designated constraints
// aren't met.
type SlashingTxSignInfoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SlashingTxSignInfoMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SlashingTxSignInfoMultiError) AllErrors() []error { return m }

// SlashingTxSignInfoValidationError is the validation error returned by
// SlashingTxSignInfo.Validate if the designated constraints aren't met.
type SlashingTxSignInfoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SlashingTxSignInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SlashingTxSignInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SlashingTxSignInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SlashingTxSignInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SlashingTxSignInfoValidationError) ErrorName() string {
	return "SlashingTxSignInfoValidationError"
}

// Error satisfies the builtin error interface
func (e SlashingTxSignInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSlashingTxSignInfo.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SlashingTxSignInfoValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SlashingTxSignInfoValidationError{}

// Validate checks the field values on BabylonPopSignInfo with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *BabylonPopSignInfo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BabylonPopSignInfo with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// BabylonPopSignInfoMultiError, or nil if none found.
func (m *BabylonPopSignInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *BabylonPopSignInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		switch v := interface{}(m.GetBabylonPop()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, BabylonPopSignInfoValidationError{
					field:  "BabylonPop",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetBabylonPop()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return BabylonPopSignInfoValidationError{
				field:  "BabylonPop",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return BabylonPopSignInfoMultiError(errors)
	}

	return nil
}

// BabylonPopSignInfoMultiError is an error wrapping multiple validation errors
// returned by BabylonPopSignInfo.ValidateAll() if the designated constraints
// aren't met.
type BabylonPopSignInfoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BabylonPopSignInfoMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BabylonPopSignInfoMultiError) AllErrors() []error { return m }

// BabylonPopSignInfoValidationError is the validation error returned by
// BabylonPopSignInfo.Validate if the designated constraints aren't met.
type BabylonPopSignInfoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BabylonPopSignInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BabylonPopSignInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BabylonPopSignInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BabylonPopSignInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BabylonPopSignInfoValidationError) ErrorName() string {
	return "BabylonPopSignInfoValidationError"
}

// Error satisfies the builtin error interface
func (e BabylonPopSignInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBabylonPopSignInfo.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BabylonPopSignInfoValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BabylonPopSignInfoValidationError{}
...
func (m *SuiSpecific) validate(all bool) error {
	...
	for idx, item := range m.GetObjects() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SuiSpecificValidationError{
			...
			if err := v.Validate(); err != nil {
				return SuiSpecificValidationError{
					field:  fmt.Sprintf("Objects[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
...
// Validate checks the field values on SuiObject with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SuiObject) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SuiObject with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SuiObjectMultiError, or nil
// if none found.
func (m *SuiObject) ValidateAll() error {
	return m.validate(true)
}

func (m *SuiObject) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SuiObjectMultiError(errors)
	}

	return nil
}

// SuiObjectMultiError is an error wrapping multiple validation errors returned
// by SuiObject.ValidateAll() if the designated constraints aren't met.
type SuiObjectMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SuiObjectMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SuiObjectMultiError) AllErrors() []error { return m }

// SuiObjectValidationError is the validation error returned by
// SuiObject.Validate if the designated constraints aren't met.
type SuiObjectValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SuiObjectValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SuiObjectValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SuiObjectValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SuiObjectValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SuiObjectValidationError) ErrorName() string { return "SuiObjectValidationError" }

// Error satisfies the builtin error interface
func (e SuiObjectValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SuiObjectValidationError{}
