...
// Validate checks the field values on GetSignerPubKeyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetSignerPubKeyRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetSignerPubKeyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetSignerPubKeyRequestMultiError, or nil if none found.
func (m *GetSignerPubKeyRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetSignerPubKeyRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if !_GetSignerPubKeyRequest_WalletId_Pattern.MatchString(m.GetWalletId()) {
		err := GetSignerPubKeyRequestValidationError{
			field:  "WalletId",
			reason: "value does not match regex pattern \"^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$\"",
		}
		if !all {
	...
	if !_GetSignerPubKeyRequest_KeyId_Pattern.MatchString(m.GetKeyId()) {
		err := GetSignerPubKeyRequestValidationError{
			field:  "KeyId",
	...
	if len(errors) > 0 {
		return GetSignerPubKeyRequestMultiError(errors)
	}

	return nil
}

// GetSignerPubKeyRequestMultiError is an error wrapping multiple validation
// errors returned by GetSignerPubKeyRequest.ValidateAll() if the designated
// constraints aren't met.
type GetSignerPubKeyRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetSignerPubKeyRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetSignerPubKeyRequestMultiError) AllErrors() []error { return m }

// GetSignerPubKeyRequestValidationError is the validation error returned by
// GetSignerPubKeyRequest.Validate if the designated constraints aren't met.
type GetSignerPubKeyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetSignerPubKeyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetSignerPubKeyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetSignerPubKeyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetSignerPubKeyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetSignerPubKeyRequestValidationError) ErrorName() string {
	return "GetSignerPubKeyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetSignerPubKeyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetSignerPubKeyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetSignerPubKeyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetSignerPubKeyRequestValidationError{}

var _GetSignerPubKeyRequest_WalletId_Pattern = regexp.MustCompile("^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")

var _GetSignerPubKeyRequest_KeyId_Pattern = regexp.MustCompile("^[0-9A-F]{64}$")

// Validate checks the field values on GetSignerPubKeyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetSignerPubKeyResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetSignerPubKeyResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetSignerPubKeyResponseMultiError, or nil if none found.
func (m *GetSignerPubKeyResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetSignerPubKeyResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetSignerPubKeyResponseMultiError(errors)
	}

	return nil
}

// GetSignerPubKeyResponseMultiError is an error wrapping multiple validation
// errors returned by GetSignerPubKeyResponse.ValidateAll() if the designated
// constraints aren't met.
type GetSignerPubKeyResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetSignerPubKeyResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetSignerPubKeyResponseMultiError) AllErrors() []error { return m }

// GetSignerPubKeyResponseValidationError is the validation error returned by
// GetSignerPubKeyResponse.Validate if the designated constraints aren't met.
type GetSignerPubKeyResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetSignerPubKeyResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetSignerPubKeyResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetSignerPubKeyResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetSignerPubKeyResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetSignerPubKeyResponseValidationError) ErrorName() string {
	return "GetSignerPubKeyResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetSignerPubKeyResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetSignerPubKeyResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetSignerPubKeyResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetSignerPubKeyResponseValidationError{}
...
// Validate checks the field values on CreateContractCreationTransactionRequest
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *CreateContractCreationTransactionRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on
// CreateContractCreationTransactionRequest with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in
// CreateContractCreationTransactionRequestMultiError, or nil if none found.
func (m *CreateContractCreationTransactionRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateContractCreationTransactionRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if !_CreateContractCreationTransactionRequest_WalletId_Pattern.MatchString(m.GetWalletId()) {
		err := CreateContractCreationTransactionRequestValidationError{
			field:  "WalletId",
			reason: "value does not match regex pattern \"^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$\"",
		}
		if !all {
	...
	if _, ok := _CreateContractCreationTransactionRequest_ContractCreationType_NotInLookup[m.GetContractCreationType()]; ok {
		err := CreateContractCreationTransactionRequestValidationError{
			field:  "ContractCreationType",
			reason: "value must not be in list [0]",
		}
		if !all {
			return err
	...
	if _, ok := gincoincglobalv1.ContractCreationType_name[int32(m.GetContractCreationType())]; !ok {
		err := CreateContractCreationTransactionRequestValidationError{
			field:  "ContractCreationType",
			reason: "value must be one of the defined enum values",
		}
	...
	if m.ContractAddress != nil {
		...
		if !_CreateContractCreationTransactionRequest_ContractAddress_Pattern.MatchString(m.GetContractAddress()) {
			err := CreateContractCreationTransactionRequestValidationError{
	...
	if len(errors) > 0 {
		return CreateContractCreationTransactionRequestMultiError(errors)
	}

	return nil
}

// CreateContractCreationTransactionRequestMultiError is an error wrapping
// multiple validation errors returned by
// CreateContractCreationTransactionRequest.ValidateAll() if the designated
// constraints aren't met.
type CreateContractCreationTransactionRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateContractCreationTransactionRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateContractCreationTransactionRequestMultiError) AllErrors() []error { return m }

// CreateContractCreationTransactionRequestValidationError is the validation
// error returned by CreateContractCreationTransactionRequest.Validate if the
// designated constraints aren't met.
type CreateContractCreationTransactionRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateContractCreationTransactionRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateContractCreationTransactionRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateContractCreationTransactionRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateContractCreationTransactionRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateContractCreationTransactionRequestValidationError) ErrorName() string {
	return "CreateContractCreationTransactionRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreateContractCreationTransactionRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateContractCreationTransactionRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateContractCreationTransactionRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateContractCreationTransactionRequestValidationError{}

var _CreateContractCreationTransactionRequest_WalletId_Pattern = regexp.MustCompile("^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")

var _CreateContractCreationTransactionRequest_ContractCreationType_NotInLookup = map[gincoincglobalv1.ContractCreationType]struct{}{
	0: {},
}

var _CreateContractCreationTransactionRequest_ContractAddress_Pattern = regexp.MustCompile("^$|^(0x)?[0-9a-fA-F]{40}$")

// Validate checks the field values on
// CreateContractCreationTransactionResponse with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CreateContractCreationTransactionResponse) Validate() error {
	return m.validate(false)
}
...
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in
// CreateContractCreationTransactionResponseMultiError, or nil if none found.
func (m *CreateContractCreationTransactionResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateContractCreationTransactionResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CreateContractCreationTransactionResponseMultiError(errors)
	}

	return nil
}

// CreateContractCreationTransactionResponseMultiError is an error wrapping
// multiple validation errors returned by
// CreateContractCreationTransactionResponse.ValidateAll() if the designated
// constraints aren't met.
type CreateContractCreationTransactionResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateContractCreationTransactionResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateContractCreationTransactionResponseMultiError) AllErrors() []error { return m }

// CreateContractCreationTransactionResponseValidationError is the validation
// error returned by CreateContractCreationTransactionResponse.Validate if the
// designated constraints aren't met.
type CreateContractCreationTransactionResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateContractCreationTransactionResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateContractCreationTransactionResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateContractCreationTransactionResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateContractCreationTransactionResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateContractCreationTransactionResponseValidationError) ErrorName() string {
	return "CreateContractCreationTransactionResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CreateContractCreationTransactionResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateContractCreationTransactionResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateContractCreationTransactionResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateContractCreationTransactionResponseValidationError{}
