...
var file_gincoinc_adamant_teller_v1_adamanttellerv1_teller_api_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x63,
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xc8,
	0x33, 0x0a, 0x09, 0x54, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x41, 0x50, 0x49, 0x12, 0x61, 0x0a, 0x0c,
	...
	0x73, 0x61, 0x67, 0x65, 0x12, 0x25, 0x2e, 0x61, 0x64, 0x61, 0x6d, 0x61, 0x6e, 0x74, 0x2e, 0x74,
	0x65, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x61, 0x64,
...
var file_gincoinc_adamant_teller_v1_adamanttellerv1_teller_api_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_gincoinc_adamant_teller_v1_adamanttellerv1_teller_api_proto_goTypes = []interface{}{
	...
	(*ProgmatCoinTransferRequest)(nil),                            // 11: adamant.teller.v1.ProgmatCoinTransferRequest
	(*ProgmatCoinBurnRequest)(nil),                                // 12: adamant.teller.v1.ProgmatCoinBurnRequest
	(*ProgmatCoinAddToWhitelistRequest)(nil),                      // 13: adamant.teller.v1.ProgmatCoinAddToWhitelistRequest
	(*ProgmatCoinRemoveFromWhitelistRequest)(nil),                 // 14: adamant.teller.v1.ProgmatCoinRemoveFromWhitelistRequest
	(*ProgmatCoinAddToBlacklistRequest)(nil),                      // 15: adamant.teller.v1.ProgmatCoinAddToBlacklistRequest
	(*ProgmatCoinRemoveFromBlacklistRequest)(nil),                 // 16: adamant.teller.v1.ProgmatCoinRemoveFromBlacklistRequest
	...
	(gincoincglobalv1.Coin)(0),                                    // 20: gincoinc.global.v1.Coin
	(adamantglobalv1.WalletType)(0),                               // 21: adamant.global.v1.WalletType
	(gincoincglobalv1.AddressType)(0),                             // 22: gincoinc.global.v1.AddressType
	(*adamantglobalv1.GetWalletRequest)(nil),                      // 23: adamant.global.v1.GetWalletRequest
	(*adamantglobalv1.ListWalletsRequest)(nil),                    // 24: adamant.global.v1.ListWalletsRequest
	(*adamantglobalv1.ListWalletsByFilterRequest)(nil),            // 25: adamant.global.v1.ListWalletsByFilterRequest
	(*adamantglobalv1.ListStakingWalletsByFilterRequest)(nil),     // 26: adamant.global.v1.ListStakingWalletsByFilterRequest
	(*adamantglobalv1.ListBaseWalletsRequest)(nil),                // 27: adamant.global.v1.ListBaseWalletsRequest
	(*adamantglobalv1.GetSpendableBalanceRequest)(nil),            // 28: adamant.global.v1.GetSpendableBalanceRequest
	(*adamantglobalv1.UpdateDestinationWalletIDRequest)(nil),      // 29: adamant.global.v1.UpdateDestinationWalletIDRequest
	(*adamantglobalv1.GetCosmosBalanceRequest)(nil),               // 30: adamant.global.v1.GetCosmosBalanceRequest
	(*adamantglobalv1.ListCosmosDelegateHistoriesRequest)(nil),    // 31: adamant.global.v1.ListCosmosDelegateHistoriesRequest
	(*adamantglobalv1.CreateAddressRequest)(nil),                  // 32: adamant.global.v1.CreateAddressRequest
	(*adamantglobalv1.CreateIOSTAccountRequest)(nil),              // 33: adamant.global.v1.CreateIOSTAccountRequest
	(*adamantglobalv1.ListSymbolChildAddressesRequest)(nil),       // 34: adamant.global.v1.ListSymbolChildAddressesRequest
	(*adamantglobalv1.GetAddressRequest)(nil),                     // 35: adamant.global.v1.GetAddressRequest
	(*adamantglobalv1.GetAddressByAddressRequest)(nil),            // 36: adamant.global.v1.GetAddressByAddressRequest
	(*adamantglobalv1.GetAddressByAddressCoinRequest)(nil),        // 37: adamant.global.v1.GetAddressByAddressCoinRequest
	(*adamantglobalv1.GetAddressByIndexRequest)(nil),              // 38: adamant.global.v1.GetAddressByIndexRequest
	(*adamantglobalv1.ListAddressesRequest)(nil),                  // 39: adamant.global.v1.ListAddressesRequest
	(*adamantglobalv1.ImportAddressRequest)(nil),                  // 40: adamant.global.v1.ImportAddressRequest
	(*adamantglobalv1.GetEthereumFeeAddressRequest)(nil),          // 41: adamant.global.v1.GetEthereumFeeAddressRequest
	(*adamantglobalv1.UpdateAddressBalanceRequest)(nil),           // 42: adamant.global.v1.UpdateAddressBalanceRequest
	(*adamantglobalv1.CreateTransactionRequest)(nil),              // 43: adamant.global.v1.CreateTransactionRequest
	(*adamantglobalv1.CancelTransactionRequest)(nil),              // 44: adamant.global.v1.CancelTransactionRequest
	(*adamantglobalv1.ReplaceTransactionRequest)(nil),             // 45: adamant.global.v1.ReplaceTransactionRequest
	(*adamantglobalv1.GetTransactionRequest)(nil),                 // 46: adamant.global.v1.GetTransactionRequest
	(*adamantglobalv1.GetTransactionByTxIDRequest)(nil),           // 47: adamant.global.v1.GetTransactionByTxIDRequest
	(*adamantglobalv1.ListTransactionsRequest)(nil),               // 48: adamant.global.v1.ListTransactionsRequest
	(*adamantglobalv1.ListTransactionsByFilterRequest)(nil),       // 49: adamant.global.v1.ListTransactionsByFilterRequest
	(*adamantglobalv1.ExitEthereumStakingValidatorsRequest)(nil),  // 50: adamant.global.v1.ExitEthereumStakingValidatorsRequest
	(*adamantglobalv1.ListTransfersRequest)(nil),                  // 51: adamant.global.v1.ListTransfersRequest
	(*adamantglobalv1.ListTransfersByFilterRequest)(nil),          // 52: adamant.global.v1.ListTransfersByFilterRequest
	(*adamantglobalv1.GetRateSnapshotRequest)(nil),                // 53: adamant.global.v1.GetRateSnapshotRequest
	(*adamantglobalv1.GetLatestRateSnapshotRequest)(nil),          // 54: adamant.global.v1.GetLatestRateSnapshotRequest
	(*adamantglobalv1.SetRatesRequest)(nil),                       // 55: adamant.global.v1.SetRatesRequest
	(*adamantglobalv1.CalculateFeeRequest)(nil),                   // 56: adamant.global.v1.CalculateFeeRequest
	(*adamantglobalv1.GetRecommendedFeeRateRequest)(nil),          // 57: adamant.global.v1.GetRecommendedFeeRateRequest
	(*adamantglobalv1.ValidateAddressRequest)(nil),                // 58: adamant.global.v1.ValidateAddressRequest
	(*adamantglobalv1.FlushBalanceRequest)(nil),                   // 59: adamant.global.v1.FlushBalanceRequest
	(*adamantglobalv1.ListAuditLogsRequest)(nil),                  // 60: adamant.global.v1.ListAuditLogsRequest
	(*adamantglobalv1.ListStakingHistoriesByFilterRequest)(nil),   // 61: adamant.global.v1.ListStakingHistoriesByFilterRequest
	(*adamantglobalv1.ListStakingValidatorsByFilterRequest)(nil),  // 62: adamant.global.v1.ListStakingValidatorsByFilterRequest
	(*adamantglobalv1.CreateWalletResponse)(nil),                  // 63: adamant.global.v1.CreateWalletResponse
	(*adamantglobalv1.Wallet)(nil),                                // 64: adamant.global.v1.Wallet
	(*adamantglobalv1.ListWalletsResponse)(nil),                   // 65: adamant.global.v1.ListWalletsResponse
	(*adamantglobalv1.ListStakingWalletsResponse)(nil),            // 66: adamant.global.v1.ListStakingWalletsResponse
	(*adamantglobalv1.ListBaseWalletsResponse)(nil),               // 67: adamant.global.v1.ListBaseWalletsResponse
	(*adamantglobalv1.GetSpendableBalanceResponse)(nil),           // 68: adamant.global.v1.GetSpendableBalanceResponse
	(*emptypb.Empty)(nil),                                         // 69: google.protobuf.Empty
	(*adamantglobalv1.GetCosmosBalanceResponse)(nil),              // 70: adamant.global.v1.GetCosmosBalanceResponse
	(*adamantglobalv1.ListCosmosDelegateHistoriesResponse)(nil),   // 71: adamant.global.v1.ListCosmosDelegateHistoriesResponse
	(*adamantglobalv1.CreateAddressResponse)(nil),                 // 72: adamant.global.v1.CreateAddressResponse
	(*adamantglobalv1.CreateIOSTAccountResponse)(nil),             // 73: adamant.global.v1.CreateIOSTAccountResponse
	(*adamantglobalv1.ListSymbolChildAddressesResponse)(nil),      // 74: adamant.global.v1.ListSymbolChildAddressesResponse
	(*adamantglobalv1.Address)(nil),                               // 75: adamant.global.v1.Address
	(*adamantglobalv1.ListAddressesResponse)(nil),                 // 76: adamant.global.v1.ListAddressesResponse
	(*adamantglobalv1.EthereumFeeAddress)(nil),                    // 77: adamant.global.v1.EthereumFeeAddress
	(*adamantglobalv1.CreateTransactionResponse)(nil),             // 78: adamant.global.v1.CreateTransactionResponse
	(*adamantglobalv1.SendTransactionResponse)(nil),               // 79: adamant.global.v1.SendTransactionResponse
	(*adamantglobalv1.ReplaceTransactionResponse)(nil),            // 80: adamant.global.v1.ReplaceTransactionResponse
	(*adamantglobalv1.Transaction)(nil),                           // 81: adamant.global.v1.Transaction
	(*adamantglobalv1.ListTransactionsResponse)(nil),              // 82: adamant.global.v1.ListTransactionsResponse
	(*adamantglobalv1.ExitEthereumStakingValidatorsResponse)(nil), // 83: adamant.global.v1.ExitEthereumStakingValidatorsResponse
	(*adamantglobalv1.ListTransfersResponse)(nil),                 // 84: adamant.global.v1.ListTransfersResponse
	(*adamantglobalv1.RateSnapshot)(nil),                          // 85: adamant.global.v1.RateSnapshot
	(*adamantglobalv1.SetRatesResponse)(nil),                      // 86: adamant.global.v1.SetRatesResponse
	(*adamantglobalv1.CalculateFeeResponse)(nil),                  // 87: adamant.global.v1.CalculateFeeResponse
	(*adamantglobalv1.GetRecommendedFeeRateResponse)(nil),         // 88: adamant.global.v1.GetRecommendedFeeRateResponse
	(*adamantglobalv1.ValidateAddressResponse)(nil),               // 89: adamant.global.v1.ValidateAddressResponse
	(*adamantglobalv1.FlushBalanceResponse)(nil),                  // 90: adamant.global.v1.FlushBalanceResponse
	(*adamantglobalv1.ListAuditLogsResponse)(nil),                 // 91: adamant.global.v1.ListAuditLogsResponse
	(*adamantglobalv1.ListStakingHistoriesResponse)(nil),          // 92: adamant.global.v1.ListStakingHistoriesResponse
	(*adamantglobalv1.ListStakingValidatorsResponse)(nil),         // 93: adamant.global.v1.ListStakingValidatorsResponse
}
var file_gincoinc_adamant_teller_v1_adamanttellerv1_teller_api_proto_depIdxs = []int32{
	20, // 0: adamant.teller.v1.CreateWalletRequest.coin:type_name -> gincoinc.global.v1.Coin
	21, // 1: adamant.teller.v1.CreateWalletRequest.wallet_type:type_name -> adamant.global.v1.WalletType
	22, // 2: adamant.teller.v1.CreateWalletRequest.address_type:type_name -> gincoinc.global.v1.AddressType
	0,  // 3: adamant.teller.v1.TellerAPI.CreateWallet:input_type -> adamant.teller.v1.CreateWalletRequest
	23, // 4: adamant.teller.v1.TellerAPI.GetWallet:input_type -> adamant.global.v1.GetWalletRequest
	24, // 5: adamant.teller.v1.TellerAPI.ListWallets:input_type -> adamant.global.v1.ListWalletsRequest
	25, // 6: adamant.teller.v1.TellerAPI.ListWalletsByFilter:input_type -> adamant.global.v1.ListWalletsByFilterRequest
	26, // 7: adamant.teller.v1.TellerAPI.ListStakingWalletsByFilter:input_type -> adamant.global.v1.ListStakingWalletsByFilterRequest
	27, // 8: adamant.teller.v1.TellerAPI.ListBaseWallets:input_type -> adamant.global.v1.ListBaseWalletsRequest
	28, // 9: adamant.teller.v1.TellerAPI.GetSpendableBalance:input_type -> adamant.global.v1.GetSpendableBalanceRequest
	...
	29, // 12: adamant.teller.v1.TellerAPI.UpdateDestinationWalletID:input_type -> adamant.global.v1.UpdateDestinationWalletIDRequest
	30, // 13: adamant.teller.v1.TellerAPI.GetCosmosBalance:input_type -> adamant.global.v1.GetCosmosBalanceRequest
	31, // 14: adamant.teller.v1.TellerAPI.ListCosmosDelegateHistories:input_type -> adamant.global.v1.ListCosmosDelegateHistoriesRequest
	32, // 15: adamant.teller.v1.TellerAPI.CreateAddress:input_type -> adamant.global.v1.CreateAddressRequest
	33, // 16: adamant.teller.v1.TellerAPI.CreateIOSTAccount:input_type -> adamant.global.v1.CreateIOSTAccountRequest
	34, // 17: adamant.teller.v1.TellerAPI.ListSymbolChildAddresses:input_type -> adamant.global.v1.ListSymbolChildAddressesRequest
	35, // 18: adamant.teller.v1.TellerAPI.GetAddress:input_type -> adamant.global.v1.GetAddressRequest
	36, // 19: adamant.teller.v1.TellerAPI.GetAddressByAddress:input_type -> adamant.global.v1.GetAddressByAddressRequest
	37, // 20: adamant.teller.v1.TellerAPI.GetAddressByAddressCoin:input_type -> adamant.global.v1.GetAddressByAddressCoinRequest
	38, // 21: adamant.teller.v1.TellerAPI.GetAddressByIndex:input_type -> adamant.global.v1.GetAddressByIndexRequest
	39, // 22: adamant.teller.v1.TellerAPI.ListAddresses:input_type -> adamant.global.v1.ListAddressesRequest
	40, // 23: adamant.teller.v1.TellerAPI.ImportAddress:input_type -> adamant.global.v1.ImportAddressRequest
	41, // 24: adamant.teller.v1.TellerAPI.GetEthereumFeeAddress:input_type -> adamant.global.v1.GetEthereumFeeAddressRequest
	42, // 25: adamant.teller.v1.TellerAPI.UpdateAddressBalance:input_type -> adamant.global.v1.UpdateAddressBalanceRequest
	43, // 26: adamant.teller.v1.TellerAPI.CreateTransaction:input_type -> adamant.global.v1.CreateTransactionRequest
	...
	44, // 29: adamant.teller.v1.TellerAPI.CancelTransaction:input_type -> adamant.global.v1.CancelTransactionRequest
	45, // 30: adamant.teller.v1.TellerAPI.ReplaceTransaction:input_type -> adamant.global.v1.ReplaceTransactionRequest
	46, // 31: adamant.teller.v1.TellerAPI.GetTransaction:input_type -> adamant.global.v1.GetTransactionRequest
	47, // 32: adamant.teller.v1.TellerAPI.GetTransactionByTxID:input_type -> adamant.global.v1.GetTransactionByTxIDRequest
	48, // 33: adamant.teller.v1.TellerAPI.ListTransactions:input_type -> adamant.global.v1.ListTransactionsRequest
	49, // 34: adamant.teller.v1.TellerAPI.ListTransactionsByFilter:input_type -> adamant.global.v1.ListTransactionsByFilterRequest
	50, // 35: adamant.teller.v1.TellerAPI.ExitEthereumStakingValidators:input_type -> adamant.global.v1.ExitEthereumStakingValidatorsRequest
	51, // 36: adamant.teller.v1.TellerAPI.ListTransfers:input_type -> adamant.global.v1.ListTransfersRequest
	52, // 37: adamant.teller.v1.TellerAPI.ListTransfersByFilter:input_type -> adamant.global.v1.ListTransfersByFilterRequest
	53, // 38: adamant.teller.v1.TellerAPI.GetRateSnapshot:input_type -> adamant.global.v1.GetRateSnapshotRequest
	54, // 39: adamant.teller.v1.TellerAPI.GetLatestRateSnapshot:input_type -> adamant.global.v1.GetLatestRateSnapshotRequest
	55, // 40: adamant.teller.v1.TellerAPI.SetRates:input_type -> adamant.global.v1.SetRatesRequest
	56, // 41: adamant.teller.v1.TellerAPI.CalculateFee:input_type -> adamant.global.v1.CalculateFeeRequest
	57, // 42: adamant.teller.v1.TellerAPI.GetRecommendedFeeRate:input_type -> adamant.global.v1.GetRecommendedFeeRateRequest
	58, // 43: adamant.teller.v1.TellerAPI.ValidateAddress:input_type -> adamant.global.v1.ValidateAddressRequest
	59, // 44: adamant.teller.v1.TellerAPI.FlushBalance:input_type -> adamant.global.v1.FlushBalanceRequest
	60, // 45: adamant.teller.v1.TellerAPI.ListAuditLogs:input_type -> adamant.global.v1.ListAuditLogsRequest
	61, // 46: adamant.teller.v1.TellerAPI.ListStakingHistoriesByFilter:input_type -> adamant.global.v1.ListStakingHistoriesByFilterRequest
	62, // 47: adamant.teller.v1.TellerAPI.ListStakingValidatorsByFilter:input_type -> adamant.global.v1.ListStakingValidatorsByFilterRequest
	...
	11, // 53: adamant.teller.v1.TellerAPI.ProgmatCoinTransfer:input_type -> adamant.teller.v1.ProgmatCoinTransferRequest
	12, // 54: adamant.teller.v1.TellerAPI.ProgmatCoinBurn:input_type -> adamant.teller.v1.ProgmatCoinBurnRequest
	13, // 55: adamant.teller.v1.TellerAPI.ProgmatCoinAddToWhitelist:input_type -> adamant.teller.v1.ProgmatCoinAddToWhitelistRequest
	14, // 56: adamant.teller.v1.TellerAPI.ProgmatCoinRemoveFromWhitelist:input_type -> adamant.teller.v1.ProgmatCoinRemoveFromWhitelistRequest
	15, // 57: adamant.teller.v1.TellerAPI.ProgmatCoinAddToBlacklist:input_type -> adamant.teller.v1.ProgmatCoinAddToBlacklistRequest
	16, // 58: adamant.teller.v1.TellerAPI.ProgmatCoinRemoveFromBlacklist:input_type -> adamant.teller.v1.ProgmatCoinRemoveFromBlacklistRequest
	17, // 59: adamant.teller.v1.TellerAPI.ProgmatCoinConfiscate:input_type -> adamant.teller.v1.ProgmatCoinConfiscateRequest
	18, // 60: adamant.teller.v1.TellerAPI.ProgmatCoinPause:input_type -> adamant.teller.v1.ProgmatCoinPauseRequest
	19, // 61: adamant.teller.v1.TellerAPI.ProgmatCoinUnpause:input_type -> adamant.teller.v1.ProgmatCoinUnpauseRequest
	63, // 62: adamant.teller.v1.TellerAPI.CreateWallet:output_type -> adamant.global.v1.CreateWalletResponse
	64, // 63: adamant.teller.v1.TellerAPI.GetWallet:output_type -> adamant.global.v1.Wallet
	65, // 64: adamant.teller.v1.TellerAPI.ListWallets:output_type -> adamant.global.v1.ListWalletsResponse
	65, // 65: adamant.teller.v1.TellerAPI.ListWalletsByFilter:output_type -> adamant.global.v1.ListWalletsResponse
	66, // 66: adamant.teller.v1.TellerAPI.ListStakingWalletsByFilter:output_type -> adamant.global.v1.ListStakingWalletsResponse
	67, // 67: adamant.teller.v1.TellerAPI.ListBaseWallets:output_type -> adamant.global.v1.ListBaseWalletsResponse
	68, // 68: adamant.teller.v1.TellerAPI.GetSpendableBalance:output_type -> adamant.global.v1.GetSpendableBalanceResponse
	69, // 69: adamant.teller.v1.TellerAPI.InitializeXRPWallet:output_type -> google.protobuf.Empty
	69, // 70: adamant.teller.v1.TellerAPI.InitializeWallet:output_type -> google.protobuf.Empty
	69, // 71: adamant.teller.v1.TellerAPI.UpdateDestinationWalletID:output_type -> google.protobuf.Empty
	70, // 72: adamant.teller.v1.TellerAPI.GetCosmosBalance:output_type -> adamant.global.v1.GetCosmosBalanceResponse
	71, // 73: adamant.teller.v1.TellerAPI.ListCosmosDelegateHistories:output_type -> adamant.global.v1.ListCosmosDelegateHistoriesResponse
	72, // 74: adamant.teller.v1.TellerAPI.CreateAddress:output_type -> adamant.global.v1.CreateAddressResponse
	73, // 75: adamant.teller.v1.TellerAPI.CreateIOSTAccount:output_type -> adamant.global.v1.CreateIOSTAccountResponse
	74, // 76: adamant.teller.v1.TellerAPI.ListSymbolChildAddresses:output_type -> adamant.global.v1.ListSymbolChildAddressesResponse
	75, // 77: adamant.teller.v1.TellerAPI.GetAddress:output_type -> adamant.global.v1.Address
	75, // 78: adamant.teller.v1.TellerAPI.GetAddressByAddress:output_type -> adamant.global.v1.Address
	75, // 79: adamant.teller.v1.TellerAPI.GetAddressByAddressCoin:output_type -> adamant.global.v1.Address
	75, // 80: adamant.teller.v1.TellerAPI.GetAddressByIndex:output_type -> adamant.global.v1.Address
	76, // 81: adamant.teller.v1.TellerAPI.ListAddresses:output_type -> adamant.global.v1.ListAddressesResponse
	69, // 82: adamant.teller.v1.TellerAPI.ImportAddress:output_type -> google.protobuf.Empty
	77, // 83: adamant.teller.v1.TellerAPI.GetEthereumFeeAddress:output_type -> adamant.global.v1.EthereumFeeAddress
	69, // 84: adamant.teller.v1.TellerAPI.UpdateAddressBalance:output_type -> google.protobuf.Empty
	78, // 85: adamant.teller.v1.TellerAPI.CreateTransaction:output_type -> adamant.global.v1.CreateTransactionResponse
	69, // 86: adamant.teller.v1.TellerAPI.SignTransaction:output_type -> google.protobuf.Empty
	79, // 87: adamant.teller.v1.TellerAPI.SendTransaction:output_type -> adamant.global.v1.SendTransactionResponse
	69, // 88: adamant.teller.v1.TellerAPI.CancelTransaction:output_type -> google.protobuf.Empty
	80, // 89: adamant.teller.v1.TellerAPI.ReplaceTransaction:output_type -> adamant.global.v1.ReplaceTransactionResponse
	81, // 90: adamant.teller.v1.TellerAPI.GetTransaction:output_type -> adamant.global.v1.Transaction
	81, // 91: adamant.teller.v1.TellerAPI.GetTransactionByTxID:output_type -> adamant.global.v1.Transaction
	82, // 92: adamant.teller.v1.TellerAPI.ListTransactions:output_type -> adamant.global.v1.ListTransactionsResponse
	82, // 93: adamant.teller.v1.TellerAPI.ListTransactionsByFilter:output_type -> adamant.global.v1.ListTransactionsResponse
	83, // 94: adamant.teller.v1.TellerAPI.ExitEthereumStakingValidators:output_type -> adamant.global.v1.ExitEthereumStakingValidatorsResponse
	84, // 95: adamant.teller.v1.TellerAPI.ListTransfers:output_type -> adamant.global.v1.ListTransfersResponse
	84, // 96: adamant.teller.v1.TellerAPI.ListTransfersByFilter:output_type -> adamant.global.v1.ListTransfersResponse
	85, // 97: adamant.teller.v1.TellerAPI.GetRateSnapshot:output_type -> adamant.global.v1.RateSnapshot
	85, // 98: adamant.teller.v1.TellerAPI.GetLatestRateSnapshot:output_type -> adamant.global.v1.RateSnapshot
	86, // 99: adamant.teller.v1.TellerAPI.SetRates:output_type -> adamant.global.v1.SetRatesResponse
	87, // 100: adamant.teller.v1.TellerAPI.CalculateFee:output_type -> adamant.global.v1.CalculateFeeResponse
	88, // 101: adamant.teller.v1.TellerAPI.GetRecommendedFeeRate:output_type -> adamant.global.v1.GetRecommendedFeeRateResponse
	89, // 102: adamant.teller.v1.TellerAPI.ValidateAddress:output_type -> adamant.global.v1.ValidateAddressResponse
	90, // 103: adamant.teller.v1.TellerAPI.FlushBalance:output_type -> adamant.global.v1.FlushBalanceResponse
	91, // 104: adamant.teller.v1.TellerAPI.ListAuditLogs:output_type -> adamant.global.v1.ListAuditLogsResponse
	92, // 105: adamant.teller.v1.TellerAPI.ListStakingHistoriesByFilter:output_type -> adamant.global.v1.ListStakingHistoriesResponse
	93, // 106: adamant.teller.v1.TellerAPI.ListStakingValidatorsByFilter:output_type -> adamant.global.v1.ListStakingValidatorsResponse
	5,  // 107: adamant.teller.v1.TellerAPI.SignMessage:output_type -> adamant.teller.v1.SignMessageResponse
	78, // 108: adamant.teller.v1.TellerAPI.ProgmatCoinInitialize:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 109: adamant.teller.v1.TellerAPI.ProgmatCoinConfigureMinter:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 110: adamant.teller.v1.TellerAPI.ProgmatCoinMintAndTransfer:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 111: adamant.teller.v1.TellerAPI.ProgmatCoinMint:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 112: adamant.teller.v1.TellerAPI.ProgmatCoinTransfer:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 113: adamant.teller.v1.TellerAPI.ProgmatCoinBurn:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 114: adamant.teller.v1.TellerAPI.ProgmatCoinAddToWhitelist:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 115: adamant.teller.v1.TellerAPI.ProgmatCoinRemoveFromWhitelist:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 116: adamant.teller.v1.TellerAPI.ProgmatCoinAddToBlacklist:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 117: adamant.teller.v1.TellerAPI.ProgmatCoinRemoveFromBlacklist:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 118: adamant.teller.v1.TellerAPI.ProgmatCoinConfiscate:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 119: adamant.teller.v1.TellerAPI.ProgmatCoinPause:output_type -> adamant.global.v1.CreateTransactionResponse
	78, // 120: adamant.teller.v1.TellerAPI.ProgmatCoinUnpause:output_type -> adamant.global.v1.CreateTransactionResponse
	62, // [62:121] is the sub-list for method output_type
	3,  // [3:62] is the sub-list for method input_type
