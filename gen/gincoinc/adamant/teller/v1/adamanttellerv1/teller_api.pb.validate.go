...
import (
	...
	globalv1 "github.com/GincoInc/gew-kmp/gen/gincoinc/adamant/global/v1/adamantglobalv1"
...
var (
	...
	_ = globalv1.WalletType(0)

	_ = globalv1.AddressType(0)
)
...
func (m *CreateWalletRequest) Validate(all bool) error {
	...
	if _, ok := globalv1.WalletType_name[int32(m.GetWalletType())]; !ok {
		err := CreateWalletRequestValidationError{
			field:  "WalletType",
			reason: "value must be one of the defined enum values",
		}
...
var _CreateWalletRequest_WalletType_NotInLookup = map[globalv1.WalletType]struct{}{
	0: {},
	2: {},
}
