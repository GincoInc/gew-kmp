...
class TellerAPIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProgmatCoinTransfer = channel.unary_unary(
                '/adamant.teller.v1.TellerAPI/ProgmatCoinTransfer',
                request_serializer=gincoinc_dot_adamant_dot_teller_dot_v1_dot_adamanttellerv1_dot_teller__api__pb2.ProgmatCoinTransferRequest.SerializeToString,
                response_deserializer=gincoinc_dot_adamant_dot_global_dot_v1_dot_adamantglobalv1_dot_global__api__pb2.CreateTransactionResponse.FromString,
                )
...
class TellerAPIServicer(object):
    ...
    def ProgmatCoinTransfer(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_TellerAPIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProgmatCoinTransfer': grpc.unary_unary_rpc_method_handler(
                    servicer.ProgmatCoinTransfer,
                    request_deserializer=gincoinc_dot_adamant_dot_teller_dot_v1_dot_adamanttellerv1_dot_teller__api__pb2.ProgmatCoinTransferRequest.FromString,
                    response_serializer=gincoinc_dot_adamant_dot_global_dot_v1_dot_adamantglobalv1_dot_global__api__pb2.CreateTransactionResponse.SerializeToString,
            ),
...
class TellerAPI(object):
    ...
    @staticmethod
    def ProgmatCoinTransfer(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/adamant.teller.v1.TellerAPI/ProgmatCoinTransfer',
            gincoinc_dot_adamant_dot_teller_dot_v1_dot_adamanttellerv1_dot_teller__api__pb2.ProgmatCoinTransferRequest.SerializeToString,
            gincoinc_dot_adamant_dot_global_dot_v1_dot_adamantglobalv1_dot_global__api__pb2.CreateTransactionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
