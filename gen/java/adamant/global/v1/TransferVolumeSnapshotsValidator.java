...
*/
public class TransferVolumeSnapshotsValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.TransferVolumeSnapshots>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.TransferVolumeSnapshots.class)) return new TransferVolumeSnapshotsValidator();
	...
	public void assertValid(java.adamant.global.v1.TransferVolumeSnapshots proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
