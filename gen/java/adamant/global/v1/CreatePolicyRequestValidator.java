...
*/
public class CreatePolicyRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.CreatePolicyRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.CreatePolicyRequest.class)) return new CreatePolicyRequestValidator();
		...
		private final java.adamant.global.v1.PolicyType[] TYPE__NOT_IN = new java.adamant.global.v1.PolicyType[]{
			java.adamant.global.v1.PolicyType.forNumber(0),
		};
	...
	public void assertValid(java.adamant.global.v1.CreatePolicyRequest proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
