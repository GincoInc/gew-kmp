...
public class GetWalletGroupRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<adamant.global.v1.GetWalletGroupRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(adamant.global.v1.GetWalletGroupRequest.class)) return new GetWalletGroupRequestValidator();
