...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(adamant.global.v1.FlushBalanceResponse result) {
      if (flushedAddressesBuilder_ == null) {
    ...
    private void buildPartial0(adamant.global.v1.FlushBalanceResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              adamant.global.v1.Model.FlushedAddress m =
                  input.readMessage(
                      adamant.global.v1.Model.FlushedAddress.parser(),
                      extensionRegistry);
              if (flushedAddressesBuilder_ == null) {
                ensureFlushedAddressesIsMutable();
                flushedAddresses_.add(m);
              } else {
                flushedAddressesBuilder_.addMessage(m);
              }
              break;
            } // case 10
            default: {
