...
*/
public class TotalBalanceValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.TotalBalance>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.TotalBalance.class)) return new TotalBalanceValidator();
	...
	public void assertValid(java.adamant.global.v1.TotalBalance proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
