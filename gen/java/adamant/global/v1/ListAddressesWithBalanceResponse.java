...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(adamant.global.v1.ListAddressesWithBalanceResponse result) {
      if (addressesBuilder_ == null) {
    ...
    private void buildPartial0(adamant.global.v1.ListAddressesWithBalanceResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              adamant.global.v1.Model.AddressWithBalance m =
                  input.readMessage(
                      adamant.global.v1.Model.AddressWithBalance.parser(),
                      extensionRegistry);
              if (addressesBuilder_ == null) {
                ensureAddressesIsMutable();
                addresses_.add(m);
