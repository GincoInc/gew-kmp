...
*/
public class UpdateLabeledAddressRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.UpdateLabeledAddressRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.UpdateLabeledAddressRequest.class)) return new UpdateLabeledAddressRequestValidator();
	...
	public void assertValid(java.adamant.global.v1.UpdateLabeledAddressRequest proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
