...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(adamant.global.v1.ListAddressesResponse result) {
      if (addressesBuilder_ == null) {
    ...
    private void buildPartial0(adamant.global.v1.ListAddressesResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              adamant.global.v1.Model.Address m =
                  input.readMessage(
                      adamant.global.v1.Model.Address.parser(),
                      extensionRegistry);
              if (addressesBuilder_ == null) {
                ensureAddressesIsMutable();
                addresses_.add(m);
