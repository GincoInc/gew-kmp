...
*/
public class GetAddressByAddressRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<adamant.global.v1.GetAddressByAddressRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(adamant.global.v1.GetAddressByAddressRequest.class)) return new GetAddressByAddressRequestValidator();
