...
*/
public class LabeledAddressValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.LabeledAddress>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.LabeledAddress.class)) return new LabeledAddressValidator();
	...
	public void assertValid(java.adamant.global.v1.LabeledAddress proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
