...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(adamant.global.v1.ListWalletsResponse result) {
      if (walletsBuilder_ == null) {
    ...
    private void buildPartial0(adamant.global.v1.ListWalletsResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              adamant.global.v1.Model.Wallet m =
                  input.readMessage(
                      adamant.global.v1.Model.Wallet.parser(),
                      extensionRegistry);
              if (walletsBuilder_ == null) {
                ensureWalletsIsMutable();
                wallets_.add(m);
