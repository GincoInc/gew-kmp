...
*/
public class SendInitTransactionRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<adamant.global.v1.SendInitTransactionRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(adamant.global.v1.SendInitTransactionRequest.class)) return new SendInitTransactionRequestValidator();
