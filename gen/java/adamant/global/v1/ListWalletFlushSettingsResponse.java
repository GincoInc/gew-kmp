...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(adamant.global.v1.ListWalletFlushSettingsResponse result) {
      if (walletFlushSettingsBuilder_ == null) {
    ...
    private void buildPartial0(adamant.global.v1.ListWalletFlushSettingsResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              adamant.global.v1.Model.WalletFlushSetting m =
                  input.readMessage(
                      adamant.global.v1.Model.WalletFlushSetting.parser(),
                      extensionRegistry);
              if (walletFlushSettingsBuilder_ == null) {
                ensureWalletFlushSettingsIsMutable();
                walletFlushSettings_.add(m);
              } else {
                walletFlushSettingsBuilder_.addMessage(m);
              }
              break;
            } // case 10
            default: {
