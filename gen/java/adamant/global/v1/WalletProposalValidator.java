...
*/
public class WalletProposalValidator implements io.envoyproxy.pgv.ValidatorImpl<java.adamant.global.v1.WalletProposal>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(java.adamant.global.v1.WalletProposal.class)) return new WalletProposalValidator();
	...
	public void assertValid(java.adamant.global.v1.WalletProposal proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
