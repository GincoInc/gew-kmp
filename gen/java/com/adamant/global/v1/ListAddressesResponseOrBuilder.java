...
public interface ListAddressesResponseOrBuilder extends
   ...
   */
  java.util.List<com.adamant.global.v1.Address> 
      getAddressesList();
  /**
   * <code>repeated .adamant.global.v1.Address addresses = 1 [json_name = "addresses"];</code>
   */
  com.adamant.global.v1.Address getAddresses(int index);
  /**
   * <code>repeated .adamant.global.v1.Address addresses = 1 [json_name = "addresses"];</code>
   */
   ...
   * <code>repeated .adamant.global.v1.Address addresses = 1 [json_name = "addresses"];</code>
   */
  java.util.List<? extends com.adamant.global.v1.AddressOrBuilder> 
      getAddressesOrBuilderList();
  /**
   * <code>repeated .adamant.global.v1.Address addresses = 1 [json_name = "addresses"];</code>
   */
  com.adamant.global.v1.AddressOrBuilder getAddressesOrBuilder(
      int index);
