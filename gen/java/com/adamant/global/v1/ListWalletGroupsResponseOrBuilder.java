...
public interface ListWalletGroupsResponseOrBuilder extends
   ...
   */
  java.util.List<com.adamant.global.v1.WalletGroup> 
      getWalletGroupsList();
  /**
   * <code>repeated .adamant.global.v1.WalletGroup wallet_groups = 1 [json_name = "walletGroups"];</code>
   */
  com.adamant.global.v1.WalletGroup getWalletGroups(int index);
  /**
   * <code>repeated .adamant.global.v1.WalletGroup wallet_groups = 1 [json_name = "walletGroups"];</code>
   */
   ...
   * <code>repeated .adamant.global.v1.WalletGroup wallet_groups = 1 [json_name = "walletGroups"];</code>
   */
  java.util.List<? extends com.adamant.global.v1.WalletGroupOrBuilder> 
      getWalletGroupsOrBuilderList();
  /**
   * <code>repeated .adamant.global.v1.WalletGroup wallet_groups = 1 [json_name = "walletGroups"];</code>
   */
  com.adamant.global.v1.WalletGroupOrBuilder getWalletGroupsOrBuilder(
      int index);
