...
public interface ListWhitelistsResponseOrBuilder extends
   ...
   */
  java.util.List<com.adamant.global.v1.Whitelist> 
      getWhitelistsList();
  /**
   * <code>repeated .adamant.global.v1.Whitelist whitelists = 1 [json_name = "whitelists"];</code>
   */
  com.adamant.global.v1.Whitelist getWhitelists(int index);
  /**
   * <code>repeated .adamant.global.v1.Whitelist whitelists = 1 [json_name = "whitelists"];</code>
   */
   ...
   * <code>repeated .adamant.global.v1.Whitelist whitelists = 1 [json_name = "whitelists"];</code>
   */
  java.util.List<? extends com.adamant.global.v1.WhitelistOrBuilder> 
      getWhitelistsOrBuilderList();
  /**
   * <code>repeated .adamant.global.v1.Whitelist whitelists = 1 [json_name = "whitelists"];</code>
   */
  com.adamant.global.v1.WhitelistOrBuilder getWhitelistsOrBuilder(
      int index);
}
