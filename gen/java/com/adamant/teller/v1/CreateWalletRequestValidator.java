...
*/
public class CreateWalletRequestValidator implements io.envoyproxy.pgv.ValidatorImpl<com.adamant.teller.v1.CreateWalletRequest>{
	public static io.envoyproxy.pgv.ValidatorImpl validatorFor(Class clazz) {
		if (clazz.equals(com.adamant.teller.v1.CreateWalletRequest.class)) return new CreateWalletRequestValidator();
		...
		private final com.adamant.global.v1.WalletType[] WALLET_TYPE__NOT_IN = new com.adamant.global.v1.WalletType[]{
			...
			com.adamant.global.v1.WalletType.forNumber(2),
		};
	...
	public void assertValid(com.adamant.teller.v1.CreateWalletRequest proto, io.envoyproxy.pgv.ValidatorIndex index) throws io.envoyproxy.pgv.ValidationException {
