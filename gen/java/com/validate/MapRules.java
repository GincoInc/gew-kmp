...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            com.validate.FieldRules.Builder subBuilder = null;
            if (((bitField0_ & 0x00000008) != 0)) {
              subBuilder = keys_.toBuilder();
            }
            keys_ = input.readMessage(com.validate.FieldRules.PARSER, extensionRegistry);
            if (subBuilder != null) {
          ...
          case 42: {
            ...
            values_ = input.readMessage(com.validate.FieldRules.PARSER, extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.validate.ValidateProto.internal_static_validate_MapRules_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.validate.ValidateProto.internal_static_validate_MapRules_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.validate.MapRules.class, com.validate.MapRules.Builder.class);
  }
  ...
  private com.validate.FieldRules keys_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public com.validate.FieldRules getKeys() {
    return keys_ == null ? com.validate.FieldRules.getDefaultInstance() : keys_;
  }
  /**
   * <pre>
   * Keys specifies the constraints to be applied to each key in the field.
   ...
   */
  @java.lang.Override
  public com.validate.FieldRulesOrBuilder getKeysOrBuilder() {
    return keys_ == null ? com.validate.FieldRules.getDefaultInstance() : keys_;
  }

  public static final int VALUES_FIELD_NUMBER = 5;
  private com.validate.FieldRules values_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public com.validate.FieldRules getValues() {
    return values_ == null ? com.validate.FieldRules.getDefaultInstance() : values_;
  }
  /**
   * <pre>
   * Values specifies the constraints to be applied to the value of each key
   ...
   */
  @java.lang.Override
  public com.validate.FieldRulesOrBuilder getValuesOrBuilder() {
    return values_ == null ? com.validate.FieldRules.getDefaultInstance() : values_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.validate.MapRules)) {
      return super.equals(obj);
    }
    com.validate.MapRules other = (com.validate.MapRules) obj;
  ...
  public static com.validate.MapRules parseFrom(
  ...
  public static com.validate.MapRules parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.validate.MapRules parseFrom(
  ...
  public static com.validate.MapRules parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.validate.MapRules parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.validate.MapRules parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.validate.MapRules prototype) {
  ...
  public static final class Builder extends
      ...
      com.validate.MapRulesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.validate.ValidateProto.internal_static_validate_MapRules_descriptor;
    }
    ...
    // Construct using com.validate.MapRules.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.validate.MapRules getDefaultInstanceForType() {
      return com.validate.MapRules.getDefaultInstance();
    }

    @java.lang.Override
    public com.validate.MapRules build() {
      com.validate.MapRules result = buildPartial();
    ...
    @java.lang.Override
    public com.validate.MapRules buildPartial() {
      com.validate.MapRules result = new com.validate.MapRules(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.validate.MapRules) {
        return mergeFrom((com.validate.MapRules)other);
      } else {
    ...
    public Builder mergeFrom(com.validate.MapRules other) {
      if (other == com.validate.MapRules.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.validate.MapRules parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.validate.MapRules) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.validate.FieldRules, com.validate.FieldRules.Builder, com.validate.FieldRulesOrBuilder> keysBuilder_;
    /**
     * <pre>
     * Keys specifies the constraints to be applied to each key in the field.
     * </pre>
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public Builder setKeys(com.validate.FieldRules value) {
      if (keysBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setKeys(
        com.validate.FieldRules.Builder builderForValue) {
      if (keysBuilder_ == null) {
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public Builder mergeKeys(com.validate.FieldRules value) {
      if (keysBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
            keys_ != null &&
            keys_ != com.validate.FieldRules.getDefaultInstance()) {
          keys_ =
            com.validate.FieldRules.newBuilder(keys_).mergeFrom(value).buildPartial();
        } else {
          keys_ = value;
        }
        onChanged();
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public com.validate.FieldRules.Builder getKeysBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
    ...
    public com.validate.FieldRulesOrBuilder getKeysOrBuilder() {
      if (keysBuilder_ != null) {
        ...
        return keys_ == null ?
            com.validate.FieldRules.getDefaultInstance() : keys_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.validate.FieldRules, com.validate.FieldRules.Builder, com.validate.FieldRulesOrBuilder> 
        getKeysFieldBuilder() {
      if (keysBuilder_ == null) {
    ...
    private com.validate.FieldRules values_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.validate.FieldRules, com.validate.FieldRules.Builder, com.validate.FieldRulesOrBuilder> valuesBuilder_;
    /**
     * <pre>
     * Values specifies the constraints to be applied to the value of each key
     * in the field. Message values will still have their validations evaluated
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public Builder setValues(com.validate.FieldRules value) {
      if (valuesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public Builder mergeValues(com.validate.FieldRules value) {
      if (valuesBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
            values_ != null &&
            values_ != com.validate.FieldRules.getDefaultInstance()) {
          values_ =
            com.validate.FieldRules.newBuilder(values_).mergeFrom(value).buildPartial();
        } else {
          values_ = value;
        }
        onChanged();
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public com.validate.FieldRules.Builder getValuesBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
    ...
    public com.validate.FieldRulesOrBuilder getValuesOrBuilder() {
      if (valuesBuilder_ != null) {
        ...
        return values_ == null ?
            com.validate.FieldRules.getDefaultInstance() : values_;
      }
    }
    /**
     * <pre>
  ...
  private static final com.validate.MapRules DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.validate.MapRules();
  }

  public static com.validate.MapRules getDefaultInstance() {
