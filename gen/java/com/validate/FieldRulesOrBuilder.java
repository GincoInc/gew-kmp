...
public interface FieldRulesOrBuilder extends
   ...
   * @return The message.
   */
  com.validate.MessageRules getMessage();
  /**
   * <code>optional .validate.MessageRules message = 17 [json_name = "message"];</code>
   */
  com.validate.MessageRulesOrBuilder getMessageOrBuilder();
   ...
   * @return The float.
   */
  com.validate.FloatRules getFloat();
  /**
   * <pre>
   * Scalar Field Types
   * </pre>
   ...
   * <code>.validate.FloatRules float = 1 [json_name = "float"];</code>
   */
  com.validate.FloatRulesOrBuilder getFloatOrBuilder();
   ...
   * @return The double.
   */
  com.validate.DoubleRules getDouble();
  /**
   * <code>.validate.DoubleRules double = 2 [json_name = "double"];</code>
   */
  com.validate.DoubleRulesOrBuilder getDoubleOrBuilder();
   ...
   * @return The int32.
   */
  com.validate.Int32Rules getInt32();
  /**
   * <code>.validate.Int32Rules int32 = 3 [json_name = "int32"];</code>
   */
  com.validate.Int32RulesOrBuilder getInt32OrBuilder();
   ...
   * @return The int64.
   */
  com.validate.Int64Rules getInt64();
  /**
   * <code>.validate.Int64Rules int64 = 4 [json_name = "int64"];</code>
   */
  com.validate.Int64RulesOrBuilder getInt64OrBuilder();
   ...
   * @return The uint32.
   */
  com.validate.UInt32Rules getUint32();
  /**
   * <code>.validate.UInt32Rules uint32 = 5 [json_name = "uint32"];</code>
   */
  com.validate.UInt32RulesOrBuilder getUint32OrBuilder();
   ...
   * @return The uint64.
   */
  com.validate.UInt64Rules getUint64();
  /**
   * <code>.validate.UInt64Rules uint64 = 6 [json_name = "uint64"];</code>
   */
  com.validate.UInt64RulesOrBuilder getUint64OrBuilder();
   ...
   * @return The sint32.
   */
  com.validate.SInt32Rules getSint32();
  /**
   * <code>.validate.SInt32Rules sint32 = 7 [json_name = "sint32"];</code>
   */
  com.validate.SInt32RulesOrBuilder getSint32OrBuilder();
   ...
   * @return The sint64.
   */
  com.validate.SInt64Rules getSint64();
  /**
   * <code>.validate.SInt64Rules sint64 = 8 [json_name = "sint64"];</code>
   */
  com.validate.SInt64RulesOrBuilder getSint64OrBuilder();
   ...
   * @return The fixed32.
   */
  com.validate.Fixed32Rules getFixed32();
  /**
   * <code>.validate.Fixed32Rules fixed32 = 9 [json_name = "fixed32"];</code>
   */
  com.validate.Fixed32RulesOrBuilder getFixed32OrBuilder();
   ...
   * @return The fixed64.
   */
  com.validate.Fixed64Rules getFixed64();
  /**
   * <code>.validate.Fixed64Rules fixed64 = 10 [json_name = "fixed64"];</code>
   */
  com.validate.Fixed64RulesOrBuilder getFixed64OrBuilder();
   ...
   * @return The sfixed32.
   */
  com.validate.SFixed32Rules getSfixed32();
  /**
   * <code>.validate.SFixed32Rules sfixed32 = 11 [json_name = "sfixed32"];</code>
   */
  com.validate.SFixed32RulesOrBuilder getSfixed32OrBuilder();
   ...
   * @return The sfixed64.
   */
  com.validate.SFixed64Rules getSfixed64();
  /**
   * <code>.validate.SFixed64Rules sfixed64 = 12 [json_name = "sfixed64"];</code>
   */
  com.validate.SFixed64RulesOrBuilder getSfixed64OrBuilder();
   ...
   * @return The bool.
   */
  com.validate.BoolRules getBool();
  /**
   * <code>.validate.BoolRules bool = 13 [json_name = "bool"];</code>
   */
  com.validate.BoolRulesOrBuilder getBoolOrBuilder();
   ...
   * @return The string.
   */
  com.validate.StringRules getString();
  /**
   * <code>.validate.StringRules string = 14 [json_name = "string"];</code>
   */
  com.validate.StringRulesOrBuilder getStringOrBuilder();
   ...
   * @return The bytes.
   */
  com.validate.BytesRules getBytes();
  /**
   * <code>.validate.BytesRules bytes = 15 [json_name = "bytes"];</code>
   */
  com.validate.BytesRulesOrBuilder getBytesOrBuilder();
   ...
   * @return The enum.
   */
  com.validate.EnumRules getEnum();
  /**
   * <pre>
   * Complex Field Types
   * </pre>
   ...
   * <code>.validate.EnumRules enum = 16 [json_name = "enum"];</code>
   */
  com.validate.EnumRulesOrBuilder getEnumOrBuilder();
   ...
   * @return The repeated.
   */
  com.validate.RepeatedRules getRepeated();
  /**
   * <code>.validate.RepeatedRules repeated = 18 [json_name = "repeated"];</code>
   */
  com.validate.RepeatedRulesOrBuilder getRepeatedOrBuilder();
   ...
   * @return The map.
   */
  com.validate.MapRules getMap();
  /**
   * <code>.validate.MapRules map = 19 [json_name = "map"];</code>
   */
  com.validate.MapRulesOrBuilder getMapOrBuilder();
   ...
   * <code>.validate.AnyRules any = 20 [json_name = "any"];</code>
   */
  com.validate.AnyRulesOrBuilder getAnyOrBuilder();
   ...
   * @return The duration.
   */
  com.validate.DurationRules getDuration();
  /**
   * <code>.validate.DurationRules duration = 21 [json_name = "duration"];</code>
   */
  com.validate.DurationRulesOrBuilder getDurationOrBuilder();
   ...
   */
  com.validate.TimestampRules getTimestamp();
  /**
   * <code>.validate.TimestampRules timestamp = 22 [json_name = "timestamp"];</code>
   */
  com.validate.TimestampRulesOrBuilder getTimestampOrBuilder();

  public com.validate.FieldRules.TypeCase getTypeCase();
}
