...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return java.validate.ValidateProto.internal_static_validate_EnumRules_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return java.validate.ValidateProto.internal_static_validate_EnumRules_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            java.validate.EnumRules.class, java.validate.EnumRules.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof java.validate.EnumRules)) {
      return super.equals(obj);
    }
    java.validate.EnumRules other = (java.validate.EnumRules) obj;
  ...
  public static java.validate.EnumRules parseFrom(
  ...
  public static java.validate.EnumRules parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static java.validate.EnumRules parseFrom(
  ...
  public static java.validate.EnumRules parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static java.validate.EnumRules parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static java.validate.EnumRules parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(java.validate.EnumRules prototype) {
  ...
  public static final class Builder extends
      ...
      java.validate.EnumRulesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return java.validate.ValidateProto.internal_static_validate_EnumRules_descriptor;
    }
    ...
    // Construct using java.validate.EnumRules.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public java.validate.EnumRules getDefaultInstanceForType() {
      return java.validate.EnumRules.getDefaultInstance();
    }

    @java.lang.Override
    public java.validate.EnumRules build() {
      java.validate.EnumRules result = buildPartial();
    ...
    @java.lang.Override
    public java.validate.EnumRules buildPartial() {
      java.validate.EnumRules result = new java.validate.EnumRules(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof java.validate.EnumRules) {
        return mergeFrom((java.validate.EnumRules)other);
      } else {
    ...
    public Builder mergeFrom(java.validate.EnumRules other) {
      if (other == java.validate.EnumRules.getDefaultInstance()) return this;
      if (other.hasConst()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      java.validate.EnumRules parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (java.validate.EnumRules) e.getUnfinishedMessage();
  ...
  private static final java.validate.EnumRules DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new java.validate.EnumRules();
  }

  public static java.validate.EnumRules getDefaultInstance() {
