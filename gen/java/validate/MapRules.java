...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            java.validate.FieldRules.Builder subBuilder = null;
            if (((bitField0_ & 0x00000008) != 0)) {
              subBuilder = keys_.toBuilder();
            }
            keys_ = input.readMessage(java.validate.FieldRules.PARSER, extensionRegistry);
            if (subBuilder != null) {
          ...
          case 42: {
            ...
            values_ = input.readMessage(java.validate.FieldRules.PARSER, extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return java.validate.ValidateProto.internal_static_validate_MapRules_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return java.validate.ValidateProto.internal_static_validate_MapRules_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            java.validate.MapRules.class, java.validate.MapRules.Builder.class);
  }
  ...
  private java.validate.FieldRules keys_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.validate.FieldRules getKeys() {
    return keys_ == null ? java.validate.FieldRules.getDefaultInstance() : keys_;
  }
  /**
   * <pre>
   * Keys specifies the constraints to be applied to each key in the field.
   ...
   */
  @java.lang.Override
  public java.validate.FieldRulesOrBuilder getKeysOrBuilder() {
    return keys_ == null ? java.validate.FieldRules.getDefaultInstance() : keys_;
  }

  public static final int VALUES_FIELD_NUMBER = 5;
  private java.validate.FieldRules values_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.validate.FieldRules getValues() {
    return values_ == null ? java.validate.FieldRules.getDefaultInstance() : values_;
  }
  /**
   * <pre>
   * Values specifies the constraints to be applied to the value of each key
   ...
   */
  @java.lang.Override
  public java.validate.FieldRulesOrBuilder getValuesOrBuilder() {
    return values_ == null ? java.validate.FieldRules.getDefaultInstance() : values_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof java.validate.MapRules)) {
      return super.equals(obj);
    }
    java.validate.MapRules other = (java.validate.MapRules) obj;
  ...
  public static java.validate.MapRules parseFrom(
  ...
  public static java.validate.MapRules parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static java.validate.MapRules parseFrom(
  ...
  public static java.validate.MapRules parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static java.validate.MapRules parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static java.validate.MapRules parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(java.validate.MapRules prototype) {
  ...
  public static final class Builder extends
      ...
      java.validate.MapRulesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return java.validate.ValidateProto.internal_static_validate_MapRules_descriptor;
    }
    ...
    // Construct using java.validate.MapRules.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public java.validate.MapRules getDefaultInstanceForType() {
      return java.validate.MapRules.getDefaultInstance();
    }

    @java.lang.Override
    public java.validate.MapRules build() {
      java.validate.MapRules result = buildPartial();
    ...
    @java.lang.Override
    public java.validate.MapRules buildPartial() {
      java.validate.MapRules result = new java.validate.MapRules(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof java.validate.MapRules) {
        return mergeFrom((java.validate.MapRules)other);
      } else {
    ...
    public Builder mergeFrom(java.validate.MapRules other) {
      if (other == java.validate.MapRules.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      java.validate.MapRules parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (java.validate.MapRules) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        java.validate.FieldRules, java.validate.FieldRules.Builder, java.validate.FieldRulesOrBuilder> keysBuilder_;
    /**
     * <pre>
     * Keys specifies the constraints to be applied to each key in the field.
     * </pre>
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public Builder setKeys(java.validate.FieldRules value) {
      if (keysBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setKeys(
        java.validate.FieldRules.Builder builderForValue) {
      if (keysBuilder_ == null) {
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public Builder mergeKeys(java.validate.FieldRules value) {
      if (keysBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
            keys_ != null &&
            keys_ != java.validate.FieldRules.getDefaultInstance()) {
          keys_ =
            java.validate.FieldRules.newBuilder(keys_).mergeFrom(value).buildPartial();
        } else {
          keys_ = value;
        }
        onChanged();
     ...
     * <code>optional .validate.FieldRules keys = 4 [json_name = "keys"];</code>
     */
    public java.validate.FieldRules.Builder getKeysBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
    ...
    public java.validate.FieldRulesOrBuilder getKeysOrBuilder() {
      if (keysBuilder_ != null) {
        ...
        return keys_ == null ?
            java.validate.FieldRules.getDefaultInstance() : keys_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        java.validate.FieldRules, java.validate.FieldRules.Builder, java.validate.FieldRulesOrBuilder> 
        getKeysFieldBuilder() {
      if (keysBuilder_ == null) {
    ...
    private java.validate.FieldRules values_;
    private com.google.protobuf.SingleFieldBuilderV3<
        java.validate.FieldRules, java.validate.FieldRules.Builder, java.validate.FieldRulesOrBuilder> valuesBuilder_;
    /**
     * <pre>
     * Values specifies the constraints to be applied to the value of each key
     * in the field. Message values will still have their validations evaluated
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public Builder setValues(java.validate.FieldRules value) {
      if (valuesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public Builder mergeValues(java.validate.FieldRules value) {
      if (valuesBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
            values_ != null &&
            values_ != java.validate.FieldRules.getDefaultInstance()) {
          values_ =
            java.validate.FieldRules.newBuilder(values_).mergeFrom(value).buildPartial();
        } else {
          values_ = value;
        }
        onChanged();
     ...
     * <code>optional .validate.FieldRules values = 5 [json_name = "values"];</code>
     */
    public java.validate.FieldRules.Builder getValuesBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
    ...
    public java.validate.FieldRulesOrBuilder getValuesOrBuilder() {
      if (valuesBuilder_ != null) {
        ...
        return values_ == null ?
            java.validate.FieldRules.getDefaultInstance() : values_;
      }
    }
    /**
     * <pre>
  ...
  private static final java.validate.MapRules DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new java.validate.MapRules();
  }

  public static java.validate.MapRules getDefaultInstance() {
