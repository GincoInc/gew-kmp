...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return java.validate.ValidateProto.internal_static_validate_StringRules_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return java.validate.ValidateProto.internal_static_validate_StringRules_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            java.validate.StringRules.class, java.validate.StringRules.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof java.validate.StringRules)) {
      return super.equals(obj);
    }
    java.validate.StringRules other = (java.validate.StringRules) obj;
  ...
  public static java.validate.StringRules parseFrom(
  ...
  public static java.validate.StringRules parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static java.validate.StringRules parseFrom(
  ...
  public static java.validate.StringRules parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static java.validate.StringRules parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static java.validate.StringRules parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(java.validate.StringRules prototype) {
  ...
  public static final class Builder extends
      ...
      java.validate.StringRulesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return java.validate.ValidateProto.internal_static_validate_StringRules_descriptor;
    }
    ...
    // Construct using java.validate.StringRules.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public java.validate.StringRules getDefaultInstanceForType() {
      return java.validate.StringRules.getDefaultInstance();
    }

    @java.lang.Override
    public java.validate.StringRules build() {
      java.validate.StringRules result = buildPartial();
    ...
    @java.lang.Override
    public java.validate.StringRules buildPartial() {
      java.validate.StringRules result = new java.validate.StringRules(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof java.validate.StringRules) {
        return mergeFrom((java.validate.StringRules)other);
      } else {
    ...
    public Builder mergeFrom(java.validate.StringRules other) {
      if (other == java.validate.StringRules.getDefaultInstance()) return this;
      if (other.hasConst()) {
        bitField0_ |= 0x00000001;
        const_ = other.const_;
        onChanged();
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      java.validate.StringRules parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (java.validate.StringRules) e.getUnfinishedMessage();
  ...
  private static final java.validate.StringRules DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new java.validate.StringRules();
  }

  public static java.validate.StringRules getDefaultInstance() {
